description = 'Example Sans2D Pixel Detector Setup without Instrument View'
...
devices = dict(
    sans2d = device('nicos.devices.instrument.Instrument',
...
startupcode = '''
printinfo("============================================================")
printinfo("Welcome to the Sans 2D (No) Instrument View demo setup.")
printinfo("============================================================")
'''
