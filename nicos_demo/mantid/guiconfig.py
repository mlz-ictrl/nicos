...
windows = [
    ...
    window('Instrument View', 'instview',
           panel('nicos_demo.mantid.gui.instview.InstrumentViewPanel')),
]
...
# Please change the sender address to a valid, instrument specif\ic address
