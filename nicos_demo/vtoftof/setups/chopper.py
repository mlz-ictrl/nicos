...
devices = dict(
    d1 = device('nicos_mlz.toftof.devices.Disc',
    ...
    d2 = device('nicos_mlz.toftof.devices.Disc',
    ...
    d3 = device('nicos_mlz.toftof.devices.Disc',
    ...
    d4 = device('nicos_mlz.toftof.devices.Disc',
    ...
    d5 = device('nicos_mlz.toftof.devices.Disc',
    ...
    d6 = device('nicos_mlz.toftof.devices.Disc',
    ...
    d7 = device('nicos_mlz.toftof.devices.Disc',
    ...
    ch = device('nicos_mlz.toftof.devices.VirtualController',
