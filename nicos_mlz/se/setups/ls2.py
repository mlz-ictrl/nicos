...
devices = {
    ...
    'T_%s_control2' % setupname : device('nicos.devices.entangle.TemperatureController',
        description = 'Loop 2',
    ...
    'T_%s_1' % setupname : device('nicos.devices.entangle.Sensor',
        description = 'Sensor 1',
        tangodevice = '%s/t_sensor1' % tango_base,
        unit = 'K',
        fmtstr = '%.3f',
    ),
    'T_%s_2' % setupname : device('nicos.devices.entangle.Sensor',
        description = 'Sensor 2',
        tangodevice = '%s/t_sensor2' % tango_base,
        unit = 'K',
        fmtstr = '%.3f',
    ),
    'T_%s_3' % setupname : device('nicos.devices.entangle.Sensor',
        description = 'Sensor 3',
        tangodevice = '%s/t_sensor3' % tango_base,
        unit = 'K',
        fmtstr = '%.3f',
    ),
    'T_%s_4' % setupname : device('nicos.devices.entangle.Sensor',
