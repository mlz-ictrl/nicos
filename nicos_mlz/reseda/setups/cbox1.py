...
devices = dict(
    ...
    cbox1 = device('nicos_mlz.reseda.devices.cbox.CBoxResonanceFrequency',
        ...
        coil2_transformer = device('nicos.devices.tango.DigitalOutput',
            ...
            tangodevice = '%s/cbox1/plc_b_transformer' % tango_base
        ),
    ),
)
