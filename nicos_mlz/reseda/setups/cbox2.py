...
devices = dict(
    ...
    cbox2 = device('nicos_mlz.reseda.devices.cbox.CBoxResonanceFrequency',
        ...
        coil2_transformer = device('nicos.devices.tango.DigitalOutput',
            ...
            tangodevice = '%s/cbox2/plc_b_transformer' % tango_base
        ),
    ),
)
