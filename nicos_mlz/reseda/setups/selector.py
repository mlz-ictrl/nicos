...
devices = dict(
   ...
   # ),
    ...
    selcradle_mot = device('nicos.devices.entangle.Motor',
        description = 'Selector rotation (motor)',
        tangodevice = '%s/selcradle' % tango_base,
        fmtstr = '%.3f',
        unit = 'deg',
        lowlevel = True,
    ),
    selcradle_enc = device('nicos.devices.entangle.Sensor',
        description = 'Selector rotation (encoder)',
