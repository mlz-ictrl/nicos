...
devices = dict(
    tap04_t_in = device('nicos_mlz.devices.memograph.MemographValue',
    ...
    tap04_t_out = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap04_p_in = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap04_p_out = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap04_flow_in = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap04_flow_out = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap04_leak = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap04_cooling = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
