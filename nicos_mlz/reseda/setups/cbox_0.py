...
devices = dict(
    ...
    cbox_0_freq = device('nicos.devices.tango.AnalogOutput',
        description = 'Frequency generator amplitude',
        tangodevice = '%s/cbox_0/fg_freq' % tango_base,
        pollinterval = 3,
        fmtstr = '%.3g'
    ),
    cbox_0_amp = device('nicos.devices.tango.AnalogOutput',
        description = 'Frequency generator amplitude',
    ...
    cbox_0_gain = device('nicos.devices.tango.AnalogOutput',
