...
devices = dict(
    ...
    T_ccr_a= device('nicos.devices.tango.Sensor',
    ...
    T_ccr_b = device('nicos.devices.tango.Sensor',
    ...
    T_ccr_c = device('nicos.devices.tango.Sensor',
    ...
    T_ccr_d = device('nicos.devices.tango.Sensor',
