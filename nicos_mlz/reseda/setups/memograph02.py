...
devices = dict(
    tap02_t_in = device('nicos_mlz.devices.memograph.MemographValue',
    ...
    tap02_t_out = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap02_p_in = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap02_p_out = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap02_flow_in = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap02_flow_out = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap02_leak = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
    ...
    tap02_cooling = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = memograph_host,
        group = 3,
