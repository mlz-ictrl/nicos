...
devices = dict(
    ...
    srz_enc = device('nicos.devices.tango.Sensor',
    ...
    stx_mot = device('nicos.devices.tango.Motor',
    ...
    stx_enc = device('nicos.devices.tango.Sensor',
    ...
    sty_mot = device('nicos.devices.tango.Motor',
    ...
    sty_enc = device('nicos.devices.tango.Sensor',
    ...
    stz_mot = device('nicos.devices.tango.Motor',
    ...
    stz_enc = device('nicos.devices.tango.Sensor',
    ...
    sgx_mot = device('nicos.devices.tango.Motor',
    ...
    sgx_enc = device('nicos.devices.tango.Sensor',
    ...
    sgy_mot = device('nicos.devices.tango.Motor',
        description = 'Sample goniometer: x',
    ...
    sgy_enc = device('nicos.devices.tango.Sensor',
