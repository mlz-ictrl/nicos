...
devices = dict(
    co_nutator1 = device('nicos.devices.entangle.Sensor',
        lowlevel = True,
        tangodevice = tango_base + 'nutator1/rotenc',
        unit = 'deg',
    ),
    mo_nutator1 = device('nicos.devices.entangle.Motor',
        lowlevel = True,
    ...
    co_nutator2 = device('nicos.devices.entangle.Sensor',
        lowlevel = True,
        tangodevice = tango_base + 'nutator2/rotenc',
        unit = 'deg',
    ),
    mo_nutator2 = device('nicos.devices.entangle.Motor',
        lowlevel = True,
