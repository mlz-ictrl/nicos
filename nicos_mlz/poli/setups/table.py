...
devices = dict(
    ...
    gamma = device('nicos.devices.tango.MotorAxis',
    ...
    chi1 = device('nicos.devices.tango.MotorAxis',
    ...
    chi2 = device('nicos.devices.tango.MotorAxis',
    ...
    xtrans = device('nicos.devices.tango.MotorAxis',
    ...
    ytrans = device('nicos.devices.tango.MotorAxis',
