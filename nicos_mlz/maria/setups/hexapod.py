...
devices = dict(
   detarm = device('nicos.devices.entangle.Motor',
    ...
    rx = device('nicos.devices.entangle.Motor',
    ...
    ry = device('nicos.devices.entangle.Motor',
    ...
    rz = device('nicos.devices.entangle.Motor',
    ...
    tx = device('nicos.devices.entangle.Motor',
    ...
    ty = device('nicos.devices.entangle.Motor',
    ...
    tz = device('nicos.devices.entangle.Motor',
