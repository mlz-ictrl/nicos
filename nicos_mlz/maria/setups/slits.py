...
devices = dict(
    s1_left = device("nicos.devices.entangle.Motor",
        description = "slit s1 left",
        tangodevice = tango_pi + "/s1_left",
        precision = 0.001,
        fmtstr = "%.3f",
    ),
    s1_right = device("nicos.devices.entangle.Motor",
    ...
    s1_bottom_mot = device("nicos.devices.entangle.Motor",
    ...
    s1_bottom_cod = device("nicos.devices.entangle.Sensor",
    ...
    s1_top_mot = device("nicos.devices.entangle.Motor",
    ...
    s1_top_cod = device("nicos.devices.entangle.Sensor",
    ...
    s2_left = device("nicos.devices.entangle.Motor",
        description = "slit s2 left",
        tangodevice = tango_pi + "/s2_left",
        precision = 0.001,
    ),
    s2_right = device("nicos.devices.entangle.Motor",
    ...
    s2_bottom_mot = device("nicos.devices.entangle.Motor",
    ...
    s2_bottom_cod = device("nicos.devices.entangle.Sensor",
    ...
    s2_top_mot = device("nicos.devices.entangle.Motor",
    ...
    s2_top_cod = device("nicos.devices.entangle.Sensor",
    ...
    ds_left = device("nicos.devices.entangle.Motor",
        description = "detector slit left",
        tangodevice = tango_s7 + "/ds_left",
        precision = 0.001,
        fmtstr = "%.3f",
    ),
    ds_right = device("nicos.devices.entangle.Motor",
