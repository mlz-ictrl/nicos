...
#        tacodevice = '//lauectrl.laue.frm2.tum.de/laue/hubermc9300/twotheta',
#        abslimits = (-1, 181),
#        fmtstr = '%.3f'
#    ),
#    omega = device('nicos.devices.taco.Motor',
#        description = 'omega angle',
#        tacodevice = '//lauectrl.laue.frm2.tum.de/laue/hubermc9300/omega',
#        abslimits = (-180, 180),
#        fmtstr = '%.3f'
#    ),
#    kappa = device('nicos.devices.taco.Motor',
#        description = 'kappa angle',
#        tacodevice = '//lauectrl.laue.frm2.tum.de/laue/hubermc9300/kappa',
#        abslimits = (-180, 180),
#        fmtstr = '%.3f'
#    ),
#    phi = device('nicos.devices.taco.Motor',
#        description = 'phi angle',
#        tacodevice = '//lauectrl.laue.frm2.tum.de/laue/hubermc9300/phi',
#        abslimits = (-360, 360),
#        fmtstr = '%.3f'
#    ),
#    stx = device('nicos.devices.taco.Motor',
#        description = 'sample x translation',
#        tacodevice = '//lauectrl.laue.frm2.tum.de/laue/hubermc9300/samplex',
#        abslimits = (-25, 25),
#        fmtstr = '%.3f'
#    ),
#    sty = device('nicos.devices.taco.Motor',
#        description = 'sample y translation',
#        tacodevice = '//lauectrl.laue.frm2.tum.de/laue/hubermc9300/sampley',
#        abslimits = (-25, 25),
#        fmtstr = '%.3f'
#    ),
#    stz = device('nicos.devices.taco.Motor',
#        description = 'sample z translation',
#        tacodevice = '//lauectrl.laue.frm2.tum.de/laue/hubermc9300/samplez',
#        abslimits = (-12, 25),
#        fmtstr = '%.3f'
#    ),
#    detz = device('nicos.devices.taco.Motor',
#        description = 'detector position',
#        tacodevice = '//lauectrl.laue.frm2.tum.de/laue/hubermc9300/detz',
#        abslimits = (100, 250),
#        fmtstr = '%.3f'
#    ),
