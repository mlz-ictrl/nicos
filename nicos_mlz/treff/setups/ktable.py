...
devices = dict(
    ...
    det_ax = device('nicos.devices.entangle.Motor',
        description = 'table X (horizontal) axis',
        tangodevice = tango_base + 'phytron/ax',
        fmtstr = '%.2f',
    ),
    det_ay = device('nicos.devices.entangle.Motor',
    ...
    # Iseg HV supply
    det_HV1 = device('nicos.devices.entangle.PowerSupply',
    ...
    det_HV2 = device('nicos.devices.entangle.PowerSupply',
    ...
    det_mca_timer = device('nicos.devices.entangle.TimerChannel',
