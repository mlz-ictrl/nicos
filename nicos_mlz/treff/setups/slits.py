...
devices = dict(
    ...
    s1_bottom = device('nicos.devices.entangle.Motor',
    ...
    s1_top = device('nicos.devices.entangle.Motor',
        description = 'Left blade of slit 1',
    ...
    s2_bottom = device('nicos.devices.entangle.Motor',
    ...
    s2_top = device('nicos.devices.entangle.Motor',
