...
devices = dict(
    sample_x = device('nicos_mlz.jcns.devices.motor.Motor',
    ...
    sample_y = device('nicos_mlz.jcns.devices.motor.Motor',
    ...
    sample_z = device('nicos_mlz.jcns.devices.motor.Motor',
    ...
    phi      = device('nicos_mlz.jcns.devices.motor.Motor',
    ...
    chi     = device('nicos_mlz.jcns.devices.motor.Motor',
