...
devices = dict(
    sample_x = device('nicos.devices.entangle.MotorAxis',
    ...
    sample_y = device('nicos.devices.entangle.MotorAxis',
    ...
    sample_z = device('nicos.devices.entangle.MotorAxis',
    ...
    phi = device('nicos.devices.entangle.MotorAxis',
    ...
    chi = device('nicos.devices.entangle.MotorAxis',
    ...
    detarm = device("nicos.devices.entangle.MotorAxis",
