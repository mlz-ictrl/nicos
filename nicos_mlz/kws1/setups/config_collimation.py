...
#    '4m (30x30)':   dict(guides=4,  ap_x=30,   ap_y=30),
    ...
    '8m (2x2) Tr':  dict(guides=8,  ap_x=2,    ap_y=2),
    '8m (6x6) Tr':  dict(guides=8,  ap_x=6,    ap_y=6),
    '8m (50x2) Tr': dict(guides=8,  ap_x=50,   ap_y=2),
...
#    '14m (30x30)':  dict(guides=14, ap_x=30,   ap_y=30),
    ...
    '14m (40x40)':  dict(guides=14, ap_x=40,   ap_y=40),
    '20m (30x30)':  dict(guides=20, ap_x=30,   ap_y=30),
    '20m (50x50)':  dict(guides=20, ap_x=50,   ap_y=50),
    '20m (50x10)':  dict(guides=20, ap_x=50,   ap_y=10),
#    '2m (50x50)':   dict(guides=2,  ap_x=50,   ap_y=50),
    '2m (40x1.3) GIWANS': dict(guides=2,  ap_x=40, ap_y=1.3),
    ...
    '4m (48x2) GISANS':   dict(guides=4,  ap_x=48,  ap_y=2),
    ...
    '8m (50x4) GISANS':   dict(guides=8,  ap_x=50, ap_y=4),
    '8m (50x6) GISANS':   dict(guides=8,  ap_x=50, ap_y=6),
    ...
    '20m (50x4) GISANS':  dict(guides=20, ap_x=50, ap_y=4),
    '20m (50x8) GISANS':  dict(guides=20, ap_x=50, ap_y=8),
