...
devices = dict(
    ...
    pol_xv = device('nicos.devices.entangle.Motor',
    ...
    pol_yv = device('nicos.devices.entangle.Motor',
    ...
    pol_xh = device('nicos.devices.entangle.Motor',
    ...
    pol_yh = device('nicos.devices.entangle.Motor',
