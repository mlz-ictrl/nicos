...
devices = dict(
    ...
    dls_shutter = device('nicos.devices.entangle.NamedDigitalOutput',
        description = 'Laser shutter for DLS',
        tangodevice = tango_base + 'shutter/open',
        mapping = {'open': 1, 'closed': 0},
    ),
    dls_limiter = device('nicos.devices.entangle.AnalogOutput',
