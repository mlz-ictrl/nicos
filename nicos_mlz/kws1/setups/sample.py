...
devices = dict(
    ...
    ap_sam_y0 = device('nicos.devices.entangle.Motor',
    ...
    ap_sam_x1 = device('nicos.devices.entangle.Motor',
    ...
    ap_sam_y1 = device('nicos.devices.entangle.Motor',
    ...
    sam_trans_x = device('nicos.devices.entangle.Motor',
    ...
    sam_trans_y = device('nicos.devices.entangle.Motor',
