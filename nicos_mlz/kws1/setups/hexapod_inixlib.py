...
description = 'Hexapod control via INIX library'
group = 'optional'
display_order = 70
...
devices = dict(
    hexapod_dt = device('nicos.devices.entangle.Motor',
    ...
    hexapod_rx = device('nicos.devices.entangle.Motor',
    ...
    hexapod_ry = device('nicos.devices.entangle.Motor',
    ...
    hexapod_rz = device('nicos.devices.entangle.Motor',
    ...
    hexapod_tx = device('nicos.devices.entangle.Motor',
    ...
    hexapod_ty = device('nicos.devices.entangle.Motor',
    ...
    hexapod_tz = device('nicos.devices.entangle.Motor',
