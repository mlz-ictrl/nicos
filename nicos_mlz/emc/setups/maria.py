...
devices = dict(
    maria_main_voltages = device(
        'nicos_mlz.emc.devices.janitza_online.VectorInput',
    ...
    maria_online = device(
        'nicos_mlz.emc.devices.janitza_online.OnlineMonitor',
