...
devices = dict(
    dns_main_voltages = device('nicos_mlz.devices.janitza_online.VectorInput',
        description = 'Voltage monitoring',
        tangodevice = tango_base + 'janitza_dns/voltages',
    ),
    dns_main_currents = device('nicos_mlz.devices.janitza_online.VectorInput',
        description = 'Current monitoring',
        tangodevice = tango_base + 'janitza_dns/currents',
    ),
    dns_main_thd = device('nicos_mlz.devices.janitza_online.VectorInput',
        description = 'Total harmonic distortion monitoring',
        tangodevice = tango_base + 'janitza_dns/thd',
    ),
    dns_online = device('nicos_mlz.devices.janitza_online.OnlineMonitor',
