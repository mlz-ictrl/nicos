...
devices = dict(
    ...
    slitm_u_m = device('nicos.devices.entangle.Motor',
        tangodevice = tango_base + 'slitm_u/motor',
        fmtstr = '%.2f',
        lowlevel = True,
    ),
    slitm_u_c = device('nicos.devices.entangle.Sensor',
    ...
    slitm_d_m = device('nicos.devices.entangle.Motor',
        tangodevice = tango_base + 'slitm_d/motor',
        fmtstr = '%.2f',
        lowlevel = True,
    ),
    slitm_d_c = device('nicos.devices.entangle.Sensor',
    ...
    slitm_l_m = device('nicos.devices.entangle.Motor',
        tangodevice = tango_base + 'slitm_l/motor',
        fmtstr = '%.2f',
        lowlevel = True,
    ),
    slitm_l_c = device('nicos.devices.entangle.Sensor',
    ...
    slitm_r_m = device('nicos.devices.entangle.Motor',
        tangodevice = tango_base + 'slitm_r/motor',
        fmtstr = '%.2f',
        lowlevel = True,
    ),
    slitm_r_c = device('nicos.devices.entangle.Sensor',
