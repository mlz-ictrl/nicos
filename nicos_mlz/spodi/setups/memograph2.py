...
tango_base = 'tango://ictrlfs.ictrl.frm2.tum.de:10000/memograph-uja02/SPODI2/'

devices = dict(
    t_in_spodi2 = device('nicos.devices.entangle.Sensor',
    ...
    t_out_spodi2 = device('nicos.devices.entangle.Sensor',
    ...
    p_in_spodi2 = device('nicos.devices.entangle.Sensor',
    ...
    p_out_spodi2 = device('nicos.devices.entangle.Sensor',
    ...
    flow_in_spodi2 = device('nicos.devices.entangle.Sensor',
    ...
    flow_out_spodi2 = device('nicos.devices.entangle.Sensor',
    ...
    leak_spodi2 = device('nicos.devices.entangle.Sensor',
    ...
    cooling_spodi2 = device('nicos.devices.entangle.Sensor',
