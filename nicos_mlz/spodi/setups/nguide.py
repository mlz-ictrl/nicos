...
devices = dict(
    p1_nguide = device('nicos.devices.tango.Sensor',
    ...
    p2_nguide = device('nicos.devices.tango.Sensor',
    ...
    p3_nguide = device('nicos.devices.tango.Sensor',
    ...
    o2_nguide = device('nicos.devices.tango.Sensor',
        description = 'O2',
    ...
    o2part_nguide = device('nicos.devices.tango.Sensor',
        description = 'O2 part',
    ...
    T_nguide = device('nicos.devices.tango.Sensor',
