...
tango_base = 'tango://ictrlfs.ictrl.frm2.tum.de:10000/memograph02/MIRA/'

devices = dict(
    t_in_fak40 = device('nicos.devices.entangle.Sensor',
    ...
    t_out_fak40 = device('nicos.devices.entangle.Sensor',
    ...
    p_in_fak40 = device('nicos.devices.entangle.Sensor',
    ...
    p_out_fak40 = device('nicos.devices.entangle.Sensor',
    ...
    flow_in_fak40 = device('nicos.devices.entangle.Sensor',
    ...
    flow_out_fak40 = device('nicos.devices.entangle.Sensor',
    ...
    leak_fak40 = device('nicos.devices.entangle.Sensor',
    ...
    cooling_fak40 = device('nicos.devices.entangle.Sensor',
