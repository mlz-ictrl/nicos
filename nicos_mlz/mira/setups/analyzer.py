...
devices = dict(
    co_ath = device('nicos.devices.entangle.Sensor',
        tangodevice = tango_base + 'detector/ath_enc',
        lowlevel = True,
        unit = 'deg',
    ),
    mo_ath = device('nicos.devices.entangle.Motor',
    ...
    co_att = device('nicos.devices.entangle.Sensor',
        tangodevice = tango_base + 'detector/att_enc',
        lowlevel = True,
        unit = 'deg',
    ),
    mo_att = device('nicos.devices.entangle.Motor',
