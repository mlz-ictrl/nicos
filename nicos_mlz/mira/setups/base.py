...
devices = dict(
    ...
    atten2_v = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    lamfilter = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    FOL = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    flip1 = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    flip2 = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    ms2pos = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    CoolTemp = device('nicos.devices.tango.AnalogInput',
