...
tango_base = 'tango://ictrlfs.ictrl.frm2.tum.de:10000/memograph-uja01/RESI/'

devices = dict(
    t_in_erwin = device('nicos.devices.entangle.Sensor',
    ...
    t_out_erwin = device('nicos.devices.entangle.Sensor',
    ...
    p_in_erwin = device('nicos.devices.entangle.Sensor',
    ...
    p_out_erwin = device('nicos.devices.entangle.Sensor',
    ...
    flow_in_erwin = device('nicos.devices.entangle.Sensor',
    ...
    flow_out_erwin = device('nicos.devices.entangle.Sensor',
    ...
    leak_erwin = device('nicos.devices.entangle.Sensor',
    ...
    cooling_erwin = device('nicos.devices.entangle.Sensor',
