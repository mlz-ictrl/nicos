...
devices = dict(
    ...
    ng_left_sw  = device('nicos.devices.taco.DigitalInput',
    ...
    ng_right_sw = device('nicos.devices.taco.DigitalInput',
    ...
    ng_bottom_sw = device('nicos.devices.taco.DigitalInput',
    ...
    ng_top_sw   = device('nicos.devices.taco.DigitalInput',
