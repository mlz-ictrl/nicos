...
devices = dict(
    ng_left = device('nicos.devices.tango.Motor',
    ...
    ng_left_sw = device('nicos.devices.tango.DigitalInput',
        description = 'Limit switch of the left motor',
        tangodevice = tango_base + 'piface/sw_left',
        fmtstr = '%d',
        lowlevel = True,
    ),
    ng_right = device('nicos.devices.tango.Motor',
    ...
    ng_right_sw = device('nicos.devices.tango.DigitalInput',
        description = 'Limit switch of the right motor',
        tangodevice = tango_base + 'piface/sw_right',
        fmtstr = '%d',
        lowlevel = True,
    ),
    ng_bottom = device('nicos.devices.tango.Motor',
    ...
    ng_bottom_sw = device('nicos.devices.tango.DigitalInput',
        description = 'Limit switch of the bottom motor',
        tangodevice = tango_base + 'piface/sw_bottom',
        fmtstr = '%d',
        lowlevel = True,
    ),
    ng_top = device('nicos.devices.tango.Motor',
    ...
    ng_top_sw = device('nicos.devices.tango.DigitalInput',
