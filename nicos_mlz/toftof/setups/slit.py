...
devices = dict(
    SampleSlitMotVB = device('nicos.devices.entangle.Motor',
        lowlevel = True,
        tangodevice = tango_base + 'ssbm',
        fmtstr = '%7.3f',
    ),
    SampleSlitMotVT = device('nicos.devices.entangle.Motor',
        lowlevel = True,
        tangodevice = tango_base + 'sstm',
        fmtstr = '%7.3f',
    ),
    SampleSlitMotHL = device('nicos.devices.entangle.Motor',
        lowlevel = True,
        tangodevice = tango_base + 'sslm',
        fmtstr = '%7.3f',
    ),
    SampleSlitMotHR = device('nicos.devices.entangle.Motor',
        lowlevel = True,
