...
devices = dict(
    # Translations
    st_ta1 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 180,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta2 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 181,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta3 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 182,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta4 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 183,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta5 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 184,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta6 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 185,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta7 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 186,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta8 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 187,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta9 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 188,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta10 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 189,
        slope = tr_slope,
        unit = 'mm',
    ...
    st_ta11 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 190,
        slope = tr_slope,
        unit = 'mm',
    ...
    # Rotations
    st_ra1 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 192,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra2 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 193,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra3 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 194,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra4 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 195,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra5 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 196,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra6 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 197,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra7 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 198,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra8 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 199,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra9 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 200,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra10 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 201,
        slope = ro_slope,
        unit = 'deg',
    ...
    st_ra11 = device('nicos_mlz.puma.devices.ReferenceMotor',
        bus = motorbus,
        addr = 202,
        slope = ro_slope,
        unit = 'deg',
