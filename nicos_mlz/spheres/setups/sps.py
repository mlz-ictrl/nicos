...
digitals = dict(
    ...
    door_closed_locked = dict(mapping= 0, desc='door closed and locked', unit='', low=True),
    housing_hatch_open = dict(mapping= 0, desc='housing hatch open', unit='', low=True),
    housing_clearance = dict(mapping= 6, desc='housing clearance', unit='', low=True),
...
background = dict(
    current = dict(desc='backgroundchopper current', limits=None, unit='', low=True),
    flow = dict(desc='backgroundchopper water flow', limits=None, unit='', low=True),
    frequency = dict(desc='backgroundchopper frequency', limits=None, unit='', low=False),
    mode = dict(desc='backgroundchopper mode (1:x)', limits=None, unit='', low=False),
    offset = dict(desc='backgroundchopper offset to pst', limits=None, unit='', low=False),
    spm1 = dict(desc='backgroundchopper primary bearing force', limits=None, unit='', low=True),
    spm2 = dict(desc='backgroundchopper primary bearing force', limits=None, unit='', low=True),
    temperature = dict(desc='backgroundchopper temperature', limits=None, unit='', low=True),
    vib = dict(desc='backgroundchopper vibration', limits=None, unit='', low=True),
)
