...
for n in range(1, 5):
    devices['compressor_%d' % n] = device('nicos.devices.entangle.NamedDigitalInput',
    ...
    devices['he_temp_%d' % n] = device('nicos.devices.entangle.Sensor',
    ...
    devices['oil_temp_%d' % n] = device('nicos.devices.entangle.Sensor',
    ...
    devices['water_temp_in_%d' % n] = device('nicos.devices.entangle.Sensor',
    ...
    devices['water_temp_out_%d' % n] = device('nicos.devices.entangle.Sensor',
    ...
    devices['he_pressure_%d' % n] = device('nicos.devices.entangle.Sensor',
