...
for n in range(1, 5):
    devices['compressor_%d' % n] = device('nicos.devices.tango.NamedDigitalInput',
    ...
    devices['he_temp_%d' % n] = device('nicos.devices.tango.Sensor',
    ...
    devices['oil_temp_%d' % n] = device('nicos.devices.tango.Sensor',
    ...
    devices['water_temp_in_%d' % n] = device('nicos.devices.tango.Sensor',
    ...
    devices['water_temp_out_%d' % n] = device('nicos.devices.tango.Sensor',
    ...
    devices['he_pressure_%d' % n] = device('nicos.devices.tango.Sensor',
