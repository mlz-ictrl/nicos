...
devices = dict(
    ...
    sorb = device('nicos.devices.generic.CacheWriter',
    ...
    onekpot = device('nicos.devices.generic.CacheReader',
        description = 'Temperature of precooling stage (1K-pot)',
        fmtstr = '%.3f',
        unit = 'K',
        maxage = 30,
    ),
    igh_p1 = device('nicos.devices.generic.CacheReader',
        description = 'Pressure P1 of IGH',
        fmtstr = '%.3f',
        unit = 'mbar',
        maxage = 30,
    ),
    igh_p2 = device('nicos.devices.generic.CacheReader',
        description = 'Pressure P2 of IGH',
        fmtstr = '%.3f',
        unit = 'mbar',
        maxage = 30,
    ),
    igh_g1 = device('nicos.devices.generic.CacheReader',
        description = 'Pressure G1 of IGH',
        fmtstr = '%.3f',
        unit = 'mbar',
        maxage = 30,
    ),
    igh_g2 = device('nicos.devices.generic.CacheReader',
        description = 'Pressure G2 of IGH',
        fmtstr = '%.3f',
        unit = 'mbar',
        maxage = 30,
    ),
    igh_g3 = device('nicos.devices.generic.CacheReader',
