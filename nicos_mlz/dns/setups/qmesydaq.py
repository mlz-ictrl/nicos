...
devices = dict(
    ...
    qmon1 = device('nicos.devices.vendor.qmesydaq.tango.CounterChannel',
        description = 'QMesyDAQ Counter0',
        tangodevice = qm_base + 'counter0',
        type = 'monitor',
    ),
    qmon2 = device('nicos.devices.vendor.qmesydaq.tango.CounterChannel',
    ...
    qtimer = device('nicos.devices.vendor.qmesydaq.tango.TimerChannel',
