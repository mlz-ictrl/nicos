...
devices = dict(
    ...
    ton_pos = device('nicos.devices.entangle.AnalogInput',
        ...
        tangodevice = tango_base + 's7_io/ton_pos',
        visibility = (),
    ),
