...
devices = dict(
    ...
    polch_Fi = device('nicos.devices.tango.NamedDigitalOutput',
        ...
        tangodevice = tango_base + 's7_digital/polarity_changer_flipper_field',
    ...
    polch_Co = device('nicos.devices.tango.NamedDigitalOutput',
        ...
        tangodevice = tango_base + 's7_digital/polarity_changer_flipper_compensation',
        mapping = polchange_mapping,
        lowlevel = True
    ),
    ...
    polch_A = device('nicos.devices.tango.NamedDigitalOutput',
        ...
        tangodevice = tango_base + 's7_digital/polarity_changer_coil_a',
        mapping = polchange_mapping,
        lowlevel = True,
    ),
    ...
    polch_B = device('nicos.devices.tango.NamedDigitalOutput',
        ...
        tangodevice = tango_base + 's7_digital/polarity_changer_coil_b',
        mapping = polchange_mapping,
        lowlevel = True,
    ),
    ...
    polch_ZB = device('nicos.devices.tango.NamedDigitalOutput',
        ...
        tangodevice = tango_base + 's7_digital/polarity_changer_coil_z_bottom',
        mapping = polchange_mapping,
        lowlevel = True,
    ),
    ...
    polch_ZT = device('nicos.devices.tango.NamedDigitalOutput',
        ...
        tangodevice = tango_base + 's7_digital/polarity_changer_coil_z_top',
        mapping = polchange_mapping,
        lowlevel = True,
    ),
    ...
    polch_C = device('nicos.devices.tango.NamedDigitalOutput',
        ...
        tangodevice = tango_base + 's7_digital/polarity_changer_coil_c',
        mapping = polchange_mapping,
        lowlevel = True,
    ),
