...
devices = dict(
    ...
    chopper_inbeam = device('nicos.devices.entangle.NamedDigitalInput',
        description = 'If chopper is in beam',
        tangodevice = tango_base + 'chopper_heben',
        mapping = {'in': 1, 'out': 0},
    ),
    chopper_wflow = device('nicos.devices.entangle.AnalogInput',
        description = 'Chopper cooling water flow',
        tangodevice = tango_base + 'kuehlmitteldurchfluss',
        fmtstr = '%.2f',
        warnlimits = (1, 2),
    ),
)
