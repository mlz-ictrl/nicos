...
_tasblock = Block('Triple-axis', [
    BlockRow(
        Field(dev='puma[0]', name='H', format='%.3f', unit=' '),
...
_rightcolumn = Column(_shutterblock,_collimationblock,
    ...
    Block('Temperature (CCR18)', [
        ...
        BlockRow(
            Field(name='T_tube',key='T_ccr18_tube', plot='T', plotwindow=3600,
                  width=40),
