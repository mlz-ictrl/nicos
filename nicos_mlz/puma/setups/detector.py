...
devices = dict(
    ...
    #     fmtstr = '%d',
    # ),
    det1 = device('nicos.devices.tango.CounterChannel',
        tangodevice = tango_base + 'counter1',
        type = 'counter',
        lowlevel = True,
        fmtstr = '%d',
    ),
    det2 = device('nicos.devices.tango.CounterChannel',
        tangodevice = tango_base + 'counter2',
        type = 'counter',
        lowlevel = True,
        fmtstr = '%d',
    ),
    det3 = device('nicos.devices.tango.CounterChannel',
        tangodevice = tango_base + 'counter3',
        type = 'counter',
        lowlevel = True,
        fmtstr = '%d',
    ),
    # det4 = device('nicos.devices.tango.CounterChannel',
    #     tangodevice = tango_base + 'b2',
    #     type = 'counter',
    #     lowlevel = True,
    #     fmtstr = '%d',
    # ),
    # det5 = device('nicos.devices.tango.CounterChannel',
