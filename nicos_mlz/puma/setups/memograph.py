...
tango_base = 'tango://ictrlfs.ictrl.frm2.tum.de:10000/memograph-uja02/PUMA/'

devices = dict(
    t_in_puma = device('nicos.devices.entangle.Sensor',
    ...
    t_out_puma = device('nicos.devices.entangle.Sensor',
    ...
    p_in_puma = device('nicos.devices.entangle.Sensor',
    ...
    p_out_puma = device('nicos.devices.entangle.Sensor',
    ...
    flow_in_puma = device('nicos.devices.entangle.Sensor',
    ...
    flow_out_puma = device('nicos.devices.entangle.Sensor',
    ...
    leak_puma = device('nicos.devices.entangle.Sensor',
    ...
    cooling_puma = device('nicos.devices.entangle.Sensor',
