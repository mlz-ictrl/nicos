    ...
    def test_nexus_sink(self, datapath):
        ...
        with h5py.File(datapath.with_suffix('.nxs'), 'r', driver='core') as h5:
            ...
            assert nxs_keys == {
                ...
                'entry/instrument/ctr',
                'entry/instrument/ctr/acquisition_mode',
                'entry/instrument/ctr/diameter',
                'entry/instrument/ctr/distance',
                'entry/instrument/ctr/layout',
                'entry/instrument/ctr/polar_angle',
                'entry/instrument/ctr/type',
                'entry/ctr_data',
                'entry/ctr_data/data',
                'entry/ctr_data/en',
                'entry/ctr_data/qh',
            ...
            assert h5['entry/instrument/ctr/polar_angle'][0] == pytest.approx(85.866, abs=1e-3)
            assert h5['entry/instrument/ctr/distance'][0] == pytest.approx(762, abs=1e-3)
