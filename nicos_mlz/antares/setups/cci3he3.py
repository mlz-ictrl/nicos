...
includes = ['alias_T', 'compressor_control']
...
devices = {
    ...
    'T_%s_C' % setupname: device('nicos.devices.taco.TemperatureSensor',
        description = 'The 2nd stage temperature',
        tacodevice = '//%s/box/ls370/sensor5' % nethost,
        unit = 'K',
        fmtstr = '%.3f',
        pollinterval = 5,
        maxage = 6,
    ...
    'T_%s_D' % setupname: device('nicos.devices.taco.TemperatureSensor',
        description = 'The 1st stage temperature',
        tacodevice = '//%s/box/ls370/sensor6' % nethost,
        unit = 'K',
        fmtstr = '%.3f',
        pollinterval = 5,
        maxage = 6,
    ...
    '%s_turbopump' % setupname: device('nicos.devices.taco.DigitalOutput',
