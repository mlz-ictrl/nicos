...
devices = dict(
    ...
    G2rz_mot = device('nicos.devices.tango.Motor',
        description = 'G2rz motor',
        tangodevice = tango_base_phy3 + 'phytron1/mot',
        lowlevel = True,
    ),
    G2rz_enc = device('nicos.devices.tango.Sensor',
    ...
    G2rz_p_mot = device('nicos.devices.tango.Motor',
        description = 'G2rz_p motor',
        tangodevice = tango_base_phy3 + 'phytron3/mot',
        lowlevel = True,
    ),
    G2rz_p_enc = device('nicos.devices.tango.Sensor',
