...
devices = dict(
    ...
    Polarity_lambda1 = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    Polarity_lambda2 = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    Polarity_lambda3 = device('nicos.devices.tango.NamedDigitalOutput',
    ...
    Polarity_lambda4 = device('nicos.devices.tango.NamedDigitalOutput',
