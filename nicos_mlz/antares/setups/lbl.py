...
devices = dict(
    lbl_l = device('nicos.devices.tango.Motor',
    ...
    lbl_r = device('nicos.devices.tango.Motor',
    ...
    lbl_b = device('nicos.devices.tango.Motor',
    ...
    lbl_t = device('nicos.devices.tango.Motor',
