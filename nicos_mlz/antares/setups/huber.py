...
devices = dict(
    stx_huber = device('nicos.devices.tango.Motor',
    ...
    sty_huber = device('nicos.devices.tango.Motor',
    ...
    sgx_huber = device('nicos.devices.tango.Motor',
    ...
    sgz_huber = device('nicos.devices.tango.Motor',
