...
devices = dict(
    ...
    EstopHuber = device('nicos.devices.entangle.NamedDigitalInput',
    ...
    EstopSlitSmall = device('nicos.devices.entangle.NamedDigitalInput',
    ...
    EstopSlitLarge = device('nicos.devices.entangle.NamedDigitalInput',
    ...
    EstopDetector = device('nicos.devices.entangle.NamedDigitalInput',
