...
tango_base = 'tango://ictrlfs.ictrl.frm2.tum.de:10000/memograph-uja03/ANTARES/'

devices = dict(
    t_in_antares = device('nicos.devices.entangle.Sensor',
    ...
    t_out_antares = device('nicos.devices.entangle.Sensor',
    ...
    p_in_antares = device('nicos.devices.entangle.Sensor',
    ...
    p_out_antares = device('nicos.devices.entangle.Sensor',
    ...
    flow_in_antares = device('nicos.devices.entangle.Sensor',
    ...
    flow_out_antares = device('nicos.devices.entangle.Sensor',
    ...
    leak_antares = device('nicos.devices.entangle.Sensor',
    ...
    cooling_antares = device('nicos.devices.entangle.Sensor',
