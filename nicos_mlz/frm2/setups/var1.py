...
devices = {
    ...
    '%s_p' % setupname: device('nicos.devices.entangle.TemperatureController',
    ...
    '%s_nv' % setupname: device('nicos.devices.entangle.AnalogOutput',
    ...
    '%s_lhe_fill' % setupname: device('nicos.devices.entangle.Sensor',
    ...
    '%s_ln2_fill' % setupname: device('nicos.devices.entangle.Sensor',
    ...
    '%s_ppump' % setupname: device('nicos.devices.entangle.Sensor',
