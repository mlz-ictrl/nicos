...
devices = dict(
    ...
    T_ccm12v_vti = device('nicos.devices.entangle.TemperatureController',
        description = 'temperature control of the VTI',
        tangodevice = tango_base + 'itc/vti_ctrl',
    ),
    T_ccm12v_stick = device('nicos.devices.entangle.TemperatureController',
        description = 'temperature control of the sample stick',
        tangodevice = tango_base + 'itc/stick_ctrl',
    ),
    ccm12v_vti_heater = device('nicos.devices.entangle.AnalogOutput',
        description = 'heater setting for VTI',
        tangodevice = tango_base + 'itc/vti_heater',
    ),
    ccm12v_vti_nv = device('nicos.devices.entangle.AnalogOutput',
        description = 'needle valve opening for VTI',
        tangodevice = tango_base + 'itc/needlevalve',
    ),
    ccm12v_vti_regulation = device('nicos.devices.entangle.NamedDigitalOutput',
    ...
    ccm12v_nv_heater = device('nicos.devices.entangle.AnalogOutput',
