...
devices = {
    ...
    'T_%s_stick' % setupname : device('nicos.devices.entangle.TemperatureController',
        description = 'The control device of the sample (stick) (loop2, sensor B)',
    ...
    'T_%s_tube' % setupname : device('nicos.devices.entangle.TemperatureController',
        description = 'The control device of the tube (loop1, Sensor D)',
    ...
    '%s_pressure_regulate' % setupname : device('nicos.devices.entangle.NamedDigitalOutput',
        description = 'selects pressure regulation',
        tangodevice = plc_tango_base + 'automatik',
        mapping = dict(off = 0, p1 = 1, p2 = 2),
    ),
    '%s_p1_limits' % setupname : device('nicos_mlz.devices.plc.ccr.PLCLimits',
        description = 'Limits for Pressure regulation on Channel 1',
        tangodevice = plc_tango_base + 'p1',
        unit = 'mbar',
    ),
    '%s_p2_limits' % setupname : device('nicos_mlz.devices.plc.ccr.PLCLimits',
