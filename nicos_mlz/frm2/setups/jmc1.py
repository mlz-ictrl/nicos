...
devices = {
    '%s_motor01' % setupname: device('nicos.devices.entangle.Motor',
    ...
    '%s_motor02' % setupname: device('nicos.devices.entangle.Motor',
    ...
    '%s_motor03' % setupname: device('nicos.devices.entangle.Motor',
    ...
    '%s_motor04' % setupname: device('nicos.devices.entangle.Motor',
