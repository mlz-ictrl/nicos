...
monitor_blocks = {
    ...
    'se': Block('ccm8v - 8T magnet', [
        BlockRow(Field(name='Field', dev='B_ccm8v'),
                 Field(name='Hall', dev='ccm8v_Bhall')),
        '---',
        BlockRow(Field(name='VTI', dev='T_ccm8v_vti'),
                 Field(name='VTI heat', dev='ccm8v_vti_heater'),
                 Field(name='VTI NV', dev='ccm8v_vti_nv')),
        BlockRow(Field(name='LT-Stick', dev='T_ccm8v_stick'),
                 Field(name='LT-Stick heat', dev='ccm8v_stick_heater')),
        BlockRow(Field(name='HT-Stick', dev='T_ccm8v_htstick'),
                 Field(name='HT-Stick heat', dev='ccm8v_htstick_heater')),
        '---',
        BlockRow(Field(name='Coils', dev='ccm8v_Tmag'),
                 Field(name='Dewar', dev='ccm8v_pdewar', unit=' '),
                 Field(name='Coldhead', dev='ccm8v_Tcoldhead')),
        BlockRow(Field(name='LHe', dev='ccm8v_LHe'),
                 Field(name='LN2', dev='ccm8v_LN2')),
    ], setups=setupname),
}
