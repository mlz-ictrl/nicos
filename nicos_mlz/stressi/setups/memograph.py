...
devices = dict(
    t_in_stressi = device('nicos_mlz.devices.memograph.MemographValue',
    ...
    t_out_stressi = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = 'memograph-uja04.care.frm2',
        group = 2,
    ...
    p_in_stressi = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = 'memograph-uja04.care.frm2',
        group = 2,
    ...
    p_out_stressi = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = 'memograph-uja04.care.frm2',
        group = 2,
    ...
    flow_in_stressi = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = 'memograph-uja04.care.frm2',
        group = 2,
    ...
    flow_out_stressi = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = 'memograph-uja04.care.frm2',
        group = 2,
    ...
    leak_stressi   = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = 'memograph-uja04.care.frm2',
        group = 2,
    ...
    cooling_stressi = device('nicos_mlz.devices.memograph.MemographValue',
        hostname = 'memograph-uja04.care.frm2',
        group = 2,
