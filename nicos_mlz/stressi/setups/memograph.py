...
tango_base = 'tango://ictrlfs.ictrl.frm2.tum.de:10000/memograph-uja04/STRESSI/'

devices = dict(
    t_in_stressi = device('nicos.devices.entangle.Sensor',
    ...
    t_out_stressi = device('nicos.devices.entangle.Sensor',
    ...
    p_in_stressi = device('nicos.devices.entangle.Sensor',
    ...
    p_out_stressi = device('nicos.devices.entangle.Sensor',
    ...
    flow_in_stressi = device('nicos.devices.entangle.Sensor',
    ...
    flow_out_stressi = device('nicos.devices.entangle.Sensor',
    ...
    leak_stressi = device('nicos.devices.entangle.Sensor',
    ...
    cooling_stressi = device('nicos.devices.entangle.Sensor',
