...
devices = dict(
    ...
    omgs_r_m = device('nicos.devices.tango.Motor',
        description = 'TTHS motor',
        tangodevice = tangobase + 'channel4/motor',
        lowlevel = True,
    ),
    omgs_r_c = device('nicos.devices.tango.Sensor',
    ...
    tths_r_m = device('nicos.devices.tango.Motor',
        description = 'TTHS motor',
        tangodevice = tangobase + 'channel3/motor',
        lowlevel = True,
    ),
    tths_r_c = device('nicos.devices.tango.Sensor',
        description = 'TTHS coder',
