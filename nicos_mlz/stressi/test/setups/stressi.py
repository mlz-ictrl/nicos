...
devices = dict(
    ...
    pss = device('nicos_mlz.stressi.devices.OffCenteredTwoAxisSlit',
        horizontal = device('nicos.devices.generic.VirtualReferenceMotor',
            unit = 'mm',
            abslimits = (0, 10),
            refswitch = 'low',
        ),
        vertical = device('nicos.devices.generic.VirtualReferenceMotor',
            unit = 'mm',
            abslimits = (0, 10),
            refswitch = 'low',
        ),
        x = device('nicos.devices.generic.VirtualReferenceMotor',
            unit = 'mm',
            abslimits = (-5, 5),
            refswitch = 'ref',
            refpos = 0,
        ),
        y = device('nicos.devices.generic.VirtualReferenceMotor',
            unit = 'mm',
            abslimits = (-5, 5),
            refswitch = 'ref',
            refpos = 0,
