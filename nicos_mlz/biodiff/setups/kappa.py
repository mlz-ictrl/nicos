...
devices = dict(
    kappa_minikappa = device('nicos.devices.entangle.Motor',
        description = 'Mini-kappa kappa axis',
        tangodevice = tango_base + 'fzjs7/kappa_mini',
        unit = 'deg',
        precision = 0.01,
    ),
    phi_minikappa = device('nicos.devices.entangle.Motor',
        description = 'Mini-kappa phi axis',
        tangodevice = tango_base + 'fzjs7/phi_mini',
        unit = 'deg',
        precision = 0.01,
    ),
    omega_minikappa = device('nicos.devices.entangle.Motor',
