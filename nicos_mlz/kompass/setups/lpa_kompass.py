...
# TODO: update the values after measuring/calibrating the coil fields
device_names = ['sf1_c', 'sf1_f', 'sf2_c', 'sf2_f', 'coil1', 'coil2', 'coil3', 'coilz']
...
devices = dict(
    ...
    gf=device('nicos_mlz.kompass.devices.gf_lpa.GF_Kompass',
              description='Vector field at sample location',
              alpha='alphastorage',
              coils=['coil1_field', 'coil2_field', 'coil3_field', 'coilz_field'],
              alphaoffset=0,
    ...
    sf2=device('nicos.devices.polarized.KFlipper',
               ...
               kvalue='kf',  # for inelastic LPA should be "kf", for elastic LPA can be "ki"
