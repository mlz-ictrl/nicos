...
devices = dict(
    t_in_resi = device('nicos.devices.entangle.Sensor',
    ...
    t_out_resi = device('nicos.devices.entangle.Sensor',
    ...
    p_in_resi = device('nicos.devices.entangle.Sensor',
    ...
    p_out_resi = device('nicos.devices.entangle.Sensor',
    ...
    flow_in_resi = device('nicos.devices.entangle.Sensor',
    ...
    flow_out_resi = device('nicos.devices.entangle.Sensor',
    ...
    leak_resi = device('nicos.devices.entangle.Sensor',
    ...
    cooling_resi = device('nicos.devices.entangle.Sensor',
