...
_shutterBlock = Block('Shutter', [
    BlockRow(
        # Field(name='Prim. shutter', dev='prim_shutt'),
...
_hoverBlock = Block('Hover feet', [
    BlockRow(
        # Field(name='Gonio/opt.Bench', dev='hover_mono'),
...
_counterBlock = Block('Counter', [
    BlockRow(
        # Field(name='Counter', dev='det1'),
        # Field(name='Monitor', dev='mon1'),
        # Field(name='Time', dev='timer'),
        ),
    BlockRow(
        # Field(name='Counter rate', dev='det1rate'),
...
_ls340Block = Block('LakeShore', [
    BlockRow(
        # Field(name='Temperature', dev='T_ls340'),
        # Field(name='Target', key='T_ls340/setpoint', unit='K'),
        ),
    BlockRow(
        # Field(name='Sensor A', dev='T_ls340_A'),
...
devices = dict(
    Monitor = device('nicos.services.monitor.qt.Monitor',
        ...
        loglevel = 'info',
        cache = 'resictrl.resi.frm2.tum.de:14869',
        # cache = 'localhost',
        font = 'Luxi Sans',
        fontsize = 10,
        timefontsize = 12,
