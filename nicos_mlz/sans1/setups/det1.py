...
devices = dict(
    ...
    DetectorSetup = device('nicos_mlz.sans1.datasinks.CopySink',
    ...
    DetectorCalibration = device('nicos_mlz.sans1.datasinks.CopySink',
    ...
    det1_image = device('nicos_mlz.sans1.devices.image.ImageChannel',
