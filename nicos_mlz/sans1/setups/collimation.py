...
#        visibility = (),
#    ),
    ng_pol = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    ng_pol_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    ng_pol_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
...
#    ),
#-------------------------------------------------------------------------------
    col_20 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_20_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_20_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    col_18 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_18_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
        description = 'Collimotor 18',
        # IP-adresse: 172.25.49.108
        tangodevice='%s/coll/col-20m/modbus'% (tangohost,),
        address = 0x4020+1*10,
    ...
    col_18_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    col_16 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_16_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_16_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    bg1 = device('nicos_mlz.sans1.devices.Sans1ColliSlit',
    ...
    bg1_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_14 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_14_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_14_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    col_12 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_12_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_12_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    col_10 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_10_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_10_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    col_8 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_8_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_8_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    col_6 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_6_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_6_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    bg2 = device('nicos_mlz.sans1.devices.Sans1ColliSlit',
    ...
    bg2_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_4 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_4_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_4_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    col_3 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_3_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
...
#    col_3_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
...
#    ),
    ...
    col_2 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    col_2_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
    ...
    col_2_c = device('nicos_mlz.sans1.devices.Sans1ColliCoder',
    ...
    sa1 = device('nicos_mlz.sans1.devices.Sans1ColliSwitcher',
    ...
    sa1_m = device('nicos_mlz.sans1.devices.Sans1ColliMotor',
