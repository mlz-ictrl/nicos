...
devices = dict(
    ...
    att = device('nicos_mlz.sans1.devices.collimotor.Sans1ColliSwitcher',
        ...
        mapping = dict(open=-2, x1000=92.8, x100=187.8, x10=282.8, dia10=377.8), #new att_m position!!
        moveable = 'att_m',
        blockingmove = False,
        pollinterval = 15,
        maxage = 60,
    ...
    col_20a_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 20a',
        motor = 'col_20a_m',
        coder = 'col_20a_c',
        dragerror = 17,
    ...
    col_20b_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 20b',
        motor = 'col_20b_m',
        coder = 'col_20b_c',
        dragerror = 17,
    ...
    col_16a_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 16a',
        motor = 'col_16a_m',
        coder = 'col_16a_c',
        dragerror = 17,
    ...
    col_16b_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 16a',
        motor = 'col_16b_m',
        coder = 'col_16b_c',
        dragerror = 17,
    ...
    col_12a_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 12a',
        motor = 'col_12a_m',
        coder = 'col_12a_c',
        dragerror = 17,
    ...
    col_12b_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 12b',
        motor = 'col_12b_m',
        coder = 'col_12b_c',
        dragerror = 17,
    ...
    col_8a_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 8a',
        motor = 'col_8a_m',
        coder = 'col_8a_c',
        dragerror = 17,
    ...
    col_8b_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 8b',
        motor = 'col_8b_m',
        coder = 'col_8b_c',
        dragerror = 17,
    ...
    col_4a_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 4a',
        motor = 'col_4a_m',
        coder = 'col_4a_c',
        dragerror = 17,
    ...
    col_4b = device('nicos_mlz.sans1.devices.collimotor.Sans1ColliSwitcher',
        ...
        #moveable = 'col_4b_a', coder hardware failure
        moveable = 'col_4b_m',
        blockingmove = False,
        pollinterval = 15,
        maxage = 60,
    ...
    col_4b_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 4b',
        motor = 'col_4b_m',
        #coder = 'col_4b_c', coder hardware failure
        coder = 'col_4b_m',
        dragerror = 17,
        precision = 0.05,
        lowlevel = True,
    ...
    col_2a_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 2a',
        motor = 'col_2a_m',
        coder = 'col_2a_c',
        dragerror = 17,
    ...
    col_2b_a = device('nicos.devices.generic.Axis',
        description = 'Collimotor 4b',
        motor = 'col_2b_m',
        coder = 'col_2b_c',
        dragerror = 17,
    ...
    sa1 = device('nicos_mlz.sans1.devices.collimotor.Sans1ColliSwitcher',
        ...
        mapping = {'30mm': 0, '20mm': 70, '10mm': 140},
        moveable = 'sa1_m',
        blockingmove = False,
        pollinterval = 15,
        maxage = 60,
