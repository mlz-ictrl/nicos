...
devices = dict(
    chopper_dru_rpm = device('nicos.devices.tango.WindowTimeoutAO',
        description = 'Chopper speed control',
        tangodevice = '%s/mainspeed' % tango_base,
        abslimits = (0, 20000),
        unit = 'rpm',
        fmtstr = '%.0f',
        timeout = 600,
    ...
    chopper_watertemp = device('nicos.devices.tango.AnalogInput',
    ...
    chopper_vacuum = device('nicos.devices.tango.AnalogInput',
...
for i in range(1, 3):
    ...
    devices['chopper_ch%i_phase' % i] = device('nicos.devices.tango.AnalogOutput',
    ...
    devices['chopper_ch%i_parkingpos' % i] = device('nicos.devices.tango.AnalogOutput',
    ...
    devices['chopper_ch%i_speed' % i] = device('nicos.devices.tango.AnalogOutput',
