...
devices = dict(
    ...
    s_slit_top = device('nicos.devices.entangle.Actuator',
        description = 'collimation slit top axis',
        tangodevice = tango_base + 'top',
        abslimits = (0, 25),
        precision = 0.05,
    ),
    s_slit_bottom = device('nicos.devices.entangle.Actuator',
        description = 'collimation slit bottom axis',
        tangodevice = tango_base + 'bottom',
        abslimits = (0, 25),
        precision = 0.05,
    ),
    s_slit_left = device('nicos.devices.entangle.Actuator',
        description = 'collimation slit left axis',
        tangodevice = tango_base + 'left',
        abslimits = (0, 25),
        precision = 0.05,
    ),
    s_slit_right = device('nicos.devices.entangle.Actuator',
