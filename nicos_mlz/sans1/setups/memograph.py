...
devices = dict(
    t_in_memograph = device('nicos_mlz.frm2.devices.memograph.MemographValue',
    ...
    t_out_memograph = device('nicos_mlz.frm2.devices.memograph.MemographValue',
                             hostname = 'memograph03.care.frm2',
                             group = 2,
    ...
    p_in_memograph = device('nicos_mlz.frm2.devices.memograph.MemographValue',
                            hostname = 'memograph03.care.frm2',
                            group = 2,
    ...
    p_out_memograph = device('nicos_mlz.frm2.devices.memograph.MemographValue',
                             hostname = 'memograph03.care.frm2',
                             group = 2,
    ...
    flow_in_memograph = device('nicos_mlz.frm2.devices.memograph.MemographValue',
                               hostname = 'memograph03.care.frm2',
                               group = 2,
    ...
    flow_out_memograph = device('nicos_mlz.frm2.devices.memograph.MemographValue',
                                hostname = 'memograph03.care.frm2',
                                group = 2,
