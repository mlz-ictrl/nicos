...
devices = dict(
    ...
    det1_hv_supply = device('nicos_mlz.sans1.devices.VoltageSupply',
    ...
    det1_hv_ax = device('nicos_mlz.sans1.devices.Sans1HV',
    ...
    det1_hv_offtime = device('nicos_mlz.sans1.devices.Sans1HVOffDuration',
        description = 'Duration below operating voltage',
        hv_supply = 'det1_hv_ax',
        maxage = 120,
        pollinterval = 15,
    ),
    det1_hv = device('nicos_mlz.sans1.devices.VoltageSwitcher',
    ...
    det1_zmot = device('nicos_mlz.sans1.devices.Sans1ZMotor',
    ...
    bs1_xenc = device('nicos_mlz.sans1.devices.FunnySensor',
    ...
    bs1_yenc = device('nicos_mlz.sans1.devices.FunnySensor',
    ...
    bs1_xax = device('nicos_mlz.sans1.devices.BeamStopAxis',
    ...
    bs1_yax = device('nicos_mlz.sans1.devices.BeamStopAxis',
    ...
    bs1 = device('nicos_mlz.sans1.devices.BeamStop',
