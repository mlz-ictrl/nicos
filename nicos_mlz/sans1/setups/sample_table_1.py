...
devices = dict(
    ...
    st1_omgmot = device('nicos.devices.entangle.Motor',
    ...
    st1_omgenc = device('nicos.devices.entangle.Sensor',
    ...
    st1_chimot = device('nicos.devices.entangle.Motor',
    ...
    st1_chienc = device('nicos.devices.entangle.Sensor',
    ...
    st1_phimot = device('nicos.devices.entangle.Motor',
    ...
    st1_phienc = device('nicos.devices.entangle.Sensor',
    ...
    st1_ymot = device('nicos.devices.entangle.Motor',
    ...
    st1_yenc = device('nicos.devices.entangle.Sensor',
    ...
    st1_zmot = device('nicos.devices.entangle.Motor',
    ...
    st1_zenc = device('nicos.devices.entangle.Sensor',
    ...
    st1_xmot = device('nicos.devices.entangle.Motor',
    ...
    st1_xenc = device('nicos.devices.entangle.Sensor',
