...
devices = dict(
    ...
    chopper_ch2_phase = device('nicos.devices.entangle.AnalogOutput',
    ...
    chopper_ch1_parkingpos = device('nicos.devices.entangle.AnalogOutput',
    ...
    chopper_ch2_parkingpos = device('nicos.devices.entangle.AnalogOutput',
