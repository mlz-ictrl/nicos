...
devices = dict(
    nok_refa1 = device(code_base + 'nok_sensor.NOKMonitoredVoltage',
    ...
    nok_refa2 = device(code_base + 'nok_sensor.NOKMonitoredVoltage',
    ...
    nok_refb1 = device(code_base + 'nok_sensor.NOKMonitoredVoltage',
    ...
    nok_refb2 = device(code_base + 'nok_sensor.NOKMonitoredVoltage',
    ...
    nok_refc1 = device(code_base + 'nok_sensor.NOKMonitoredVoltage',
    ...
    nok_refc2 = device(code_base + 'nok_sensor.NOKMonitoredVoltage',
