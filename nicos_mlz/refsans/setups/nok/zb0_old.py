...
devices = dict(
    ...
    # Debug (slit)
    # Debug (k1)
    zb0_old = device('nicos_mlz.refsans.devices.nok_support.SingleMotorNOK',
        description = 'ZB0',
        motor = 'zb0_motor',
        coder = 'zb0_motor',
        obs = ['zb0_obs'],
    ...
    zb0_motor = device('nicos_mlz.refsans.devices.nok_support.NOKMotorIPC',
    ...
    zb0_obs = device('nicos_mlz.refsans.devices.nok_support.NOKPosition',
    ...
    # generated from global/inf/poti_tracing.inf
    zb0_poti = device('nicos_mlz.refsans.devices.nok_support.NOKMonitoredVoltage',
