...
visibility = ()
dix_visibility = ('devlist', 'namespace')
#dix_visibility = (),

det_pix_height = 2.095 #2026-02-24 08:22:50 GM 2.093
det_pix_width = 2.923 #2026-02-24 08:22:14 GM 2.072

devices = dict(
    det_pix_height = device('nicos.devices.generic.ManualMove',
        description = 'height of detector pixel',
        abslimits = (det_pix_height, det_pix_height),
        default = det_pix_height,
        target = det_pix_height,
        unit = 'mm',
    ),
    det_pix_width = device('nicos.devices.generic.ManualMove',
        description = 'width of detector pixel',
        abslimits = (det_pix_width, det_pix_width),
        default = det_pix_width,
        target = det_pix_width,
        unit = 'mm',
    ),
    ...
    det_table_motor = device('nicos.devices.entangle.Actuator',
        description = 'table inside scatteringtube backlash in Beckhoff',
        # tangodevice = tango_base + 'det_table/plc/_TablePosition',
        tangodevice = tango_base + 'det_table/plc/TablePosition',
        unit = 'mm',
        precision = 20,
        userlimits = (1064.342, 10864.215),  # for Cd (1140, 11025),
        visibility = (),
    ),
    ...
    det_table_ctrl = device(code_base + 'controls.TemperatureControlled',
        description = 'table inside the scattering tube',
