...
devices = dict(
    ...
    basis = device(code_base + 'Group',
        ...
        bitlist = ['Safedetectrosystem',
                   ...
                   'Handbetrieb_tube_inv',
                   'Hupentest_inv',
                   'Lampentest_inv',
                   'Probenort_Geraeumt_inv',
                   'Schluesselschalter_Wartung_inv',
                   'Schnellschluss-Shutter_auf', 'Schnellschluss-Shutter_zu',
                   'Streurohr_Geraeumt_inv', 'Tuer_PO_auf', 'Tuer_PO_zu',
                   'Tuer_SR_auf', 'Tuer_SR_zu', 'Verbindung_zu_Warte_iO',
                   'Verbindungstuer',
                   ],
        okmask = 0b110101001000001111010011,
        #   0987654321098765432109876543210
    ),
    Safedetectorsystem = device(code_base + 'Group',
        description = 'Safedetectrosystem',
        shs = 'safetysystem',
        bitlist = ['Safedetectrosystem'],
        okmask = 0b1,
        visibility = lowlevel,
    ),
    Instrumentenverantwortlicher = device(code_base + 'Group',
        description = 'Instrumentenverantwortlicher',
        shs = 'safetysystem',
        bitlist = ['Instrumentenverantwortlicher'],
        okmask = 0b1,
        visibility = lowlevel,
    ),
    Freigabe_Taster = device(code_base + 'Group',
        description = 'Freigabe_Taster',
        shs = 'safetysystem',
        bitlist = ['Freigabe_Taster'],
        okmask = 0b0,
        visibility = lowlevel,
    ),
