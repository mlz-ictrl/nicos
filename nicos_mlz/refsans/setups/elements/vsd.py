...
devices = dict(
    ...
    Temperature1 = device(code_base + 'AnalogValue',
        description = 'VSD: Analog value of Temperature7 Core of choppermotor 5',
        iodev = '_vsdio',
        channel = 'Temperature1',
        unit = 'degC',
        visibility = temperature_on,
    ),
    chopper5_temp = device(code_base_analog,
        description = 'Temperature of motorcoil 5',
        device = 'Temperature1',
        poly = [-13.5, 1],  #2024-03-21 [-13, 1] # 2022-11-30 10:00:34 -10
        unit = 'degC',
        visibility = (),
    ),
    ...
    chopper6_temp = device(code_base_analog,
        description = 'Temperature of motorcoil 6',
        device = 'Temperature3',
        poly = [-14.6, 1],  #2024-03-21 [-16, 1]# 2022-11-30 10:00:44 -10
        unit = 'degC',
        visibility = (),
    ),
    ...
    chopper4_temp = device(code_base_analog,
        description = 'Temperature of motorcoil 4',
        device = 'Temperature5',
        poly = [-16.2, 1], # 2024-02-23 [-16.9, 1],  # 2022-11-30 09:21:48 -10.1
        unit = 'degC',
        visibility = (),
    ),
    ...
    chopper3_temp = device(code_base_analog,
        description = 'Temperature of motorcoil 3',
        device = 'Temperature6',
        poly = [-18.6, 1], # 2024-02-23 [-19.1, 1],  # 2022-11-30 09:21:36 -11.0
        unit = 'degC',
        visibility = (),
    ),
    ...
    chopper2_temp = device(code_base_analog,
        description = 'Temperature of motorcoil 2',
        device = 'Temperature7',
        poly = [-15.7, 1],  # 2024-02-23 08:15:06 [-16.5, 1],  # 2022-11-30 09:21:27 -9.3
        unit = 'degC',
        visibility = (),
    ),
    ...
    chopper1_temp = device(code_base_analog,
        description = 'Temperature of motorcoil 1',
        device = 'Temperature8',
        poly = [-13.2, 1],  #2024-02-23 [-14.1, 1],  # 2022-11-30 09:21:17 -6.8
        unit = 'degC',
        visibility = (),
    ),
    ...
    Water1Flow = device(code_base + 'AnalogValue',
        description = 'VSD: Analog value of Water1Flow Masterchoppper 1-4',
        iodev = '_vsdio',
        channel = 'Water1Flow',
        unit = 'l/min',
        visibility = cooling,
    ...
    Water1Temp = device(code_base + 'AnalogValue',
        description = 'VSD: Analog value of Water1Temp Masterchoppper 1-4',
        iodev = '_vsdio',
        channel = 'Water1Temp',
        unit = 'degC',
        visibility = cooling,
    ...
    Water2Flow = device(code_base + 'AnalogValue',
        description = 'VSD: Analog value of Water2Flow Slavechopper 5-6',
        iodev = '_vsdio',
        channel = 'Water2Flow',
        unit = 'l/min',
        visibility = cooling,
    ...
    Water2Temp = device(code_base + 'AnalogValue',
        description = 'VSD: Analog value of Water2Temp Slavechopper 5-6',
        iodev = '_vsdio',
        channel = 'Water2Temp',
        unit = 'degC',
        visibility = cooling,
