...
devices = dict(
    ...
    pump_CB = device('nicos.devices.generic.Switcher',
        ...
        moveable = device('nicos.devices.tango.DigitalOutput',
    ...
    pressuresetpoint3 = device('nicos.devices.tango.Sensor',
        description = 'Pressure in CB (provided by Pumpstand)',
        tangodevice = tango_base + '_param_setpoint3',
        lowlevel = True,
    ),
    pressurefehlerbits = device('nicos.devices.tango.Sensor',
        description = 'Pressure in CB (provided by Pumpstand)',
        tangodevice = tango_base + '_state_fehlerbits',
        lowlevel = True,
    ),
    pressureventile = device('nicos.devices.tango.Sensor',
        description = 'Pressure in CB (provided by Pumpstand)',
