...
devices = dict(
    ...
    pressure_SR = device('nicos_mlz.refsans.devices.beckhoff.pumpstation.PumpstandPressure',
        description = 'Pressure in SR (provided by Pumpstand)',
        iodev = 'pumpstand',
        chamber = 'SR',
        # limits = (turn_pump_off_below_this_pressure, turn_pump_on_above_this_pressure),
    ),
    pressure_SFK = device('nicos_mlz.refsans.devices.beckhoff.pumpstation.PumpstandPressure',
    ...
    pump_CB = device('nicos.devices.generic.Switcher',
        ...
        moveable = device('nicos_mlz.refsans.devices.beckhoff.pumpstation.PumpstandPump',
