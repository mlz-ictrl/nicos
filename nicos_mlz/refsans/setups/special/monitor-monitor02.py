...
_SFKammer = Column(
    Block('Vertical Shifts for Optic Elements in the Neutron Guide System', [
        BlockRow(
                 ...
                 Field(name=u'zb\u2082',    dev='zb2_motor', width=layout_width, unit='(mm)'),
                 ),
        BlockRow(
                 Field(name=u'nok7\u1d63',  dev='nok7r_motor', width=layout_width, unit='(mm)'),
                 Field(name=u'nok7\u209b',  dev='nok7s_motor', width=layout_width, unit='(mm)'),
                 Field(name=u'zb\u2083',    dev='zb3.center', width=layout_width, unit='(mm)'),
                 Field(name=u'nok8\u1d63',  dev='nok8r_motor', width=layout_width, unit='(mm)'),
                 Field(name=u'nok8\u209b',  dev='nok8s_motor', width=layout_width, unit='(mm)'),
                 Field(name=u'bs\u2081',    dev='bs1.center', width=layout_width, unit='(mm)'),
                 Field(name=u'nok9\u1d63',  dev='nok9r_motor', width=layout_width, unit='(mm)'),
                 Field(name=u'nok9\u209b',  dev='nok9s_motor', width=layout_width, unit='(mm)'),
