...
_chconfigcol = Column(
    ...
    Block(' Chopper Configuration ', [
        BlockRow(
            Field(name='\u03bb\u2098\u1d62\u2099', key='chopper/wlmin',
        ...
        BlockRow(
            Field(name='angular speed', key='chopper/speed', width=10,
                  format = '%.1f', unit='(rpm)'),
            Field(name='disk 2 phase', key='chopper2/phase', width=10,
                  format = '%.2f', unit='(deg)'),
            Field(name='disk 3 phase', key='chopper3/phase', width=10,
                  format = '%.2f', unit='(deg)'),
            Field(name='disk 4 phase', key='chopper4/phase', width=10,
                  format = '%.2f', unit='(deg)'),
            Field(name='disk 5 phase', key='chopper5/phase', width=10,
                  format = '%.2f', unit='(deg)'),
            Field(name='disk 6 phase', key='chopper6/phase', width=10,
                  format = '%.2f', unit='(deg)'),
        ),
        ],
    ),
    ...
    Block(' Chopper Settings ', [
        BlockRow(
            ...
            # real_flight_path
            Field(name='disc1 - detector distance', dev='real_flight_path',
                  width=14, format='%.3f', unit='(m)'),
            Field(name='resolution \u0394\u03bb/\u03bb ', dev='resolution',
                  width=14, format='%.2f', unit='(%)'),
            Field(name='start delay', key='chopper/delay', width=10,
                  format='%.2f', unit='(deg)'),
        ),
        BlockRow(
            Field(name='angular speed', dev='chopper_speed', width=10,
                  format='%.1f', unit='(rpm)'),
            Field(name='Disk 2 phase', dev='cpt2', width=10, format='%.2f',
                  unit='(deg)'),
            Field(name='Disk 3 phase', dev='cpt3', width=10, format='%.2f',
                  unit='(deg)'),
            Field(name='Disk 4 phase', dev='cpt4', width=10, format='%.2f',
                  unit='(deg)'),
            Field(name='Disk 5 phase', dev='cpt5', width=10, format='%.2f',
                  unit='(deg)'),
            Field(name='Disk 6 phase', dev='cpt6', width=10, format='%.2f',
                  unit='(deg)'),
        ),
        ],
    ),
