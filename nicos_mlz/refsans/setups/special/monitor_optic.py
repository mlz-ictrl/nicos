    ...
    Block('beam guide setting',[
        BlockRow(
            ...
            Field(dev='shutter_gamma', name='gamma',
                  ...
                  options=['open', 'closed'],
                  width=6.5, height=9),
            Field(dev='nok2_mode', name='nok2',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['ng'],
                  width=6.5, height=9),
            Field(dev='nok3_mode', name='nok3',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['ng', 'rc'],
                  width=6.5, height=9),
            Field(dev='nok4_mode', name='nok4',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['ng', 'rc'],
                  width=6.5, height=9),
            Field(dev='b1_mode', name='b1',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['slit', 'gisans', 'point'],
                  width=6.5, height=9),
            Field(dev='nok5a_mode', name='nok5a',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['fc', 'vc', 'ng', 'pola'],
                  width=6.5, height=9),
            Field(dev='zb0_mode', name='zb0',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['slit', 'gisans', 'point'],
                  width=6.5, height=9),
            Field(dev='nok5b_mode', name='nok5b',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['fc', 'vc', 'ng'],
                  width=6.5, height=9),
            Field(dev='zb1_mode', name='zb1',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['slit', 'gisans', 'point'],
                  width=6.5, height=9),
            Field(dev='nok6_mode', name='nok6',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['fc', 'vc', 'ng'],
                  width=6.5, height=9),
            Field(dev='zb2_mode', name='zb2',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['slit', 'gisans', 'point'],
                  width=6.5, height=9),
            Field(dev='nok7_mode', name='nok7',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['fc', 'vc', 'ng'],
                  width=6.5, height=9),
            Field(dev='zb3_mode', name='zb3',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['slit', 'gisans', 'point'],
                  width=6.5, height=9),
            Field(dev='nok8_mode', name='nok8',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['fc', 'vc', 'ng'],
                  width=6.5, height=9),
            Field(dev='bs1_mode', name='bs1',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['slit', 'gisans', 'point'],
                  width=6.5, height=9),
            Field(dev='nok9_mode', name='nok9',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['fc', 'vc', 'ng'],
                  width=6.5, height=9),
            Field(dev='b2_mode', name='b2',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['slit', 'gisans', 'pinhole'],
                  width=6.5, height=9),
            Field(dev='b3_mode', name='b3',
                  widget='nicos_mlz.sans1.gui.monitorwidgets.CollimatorTable',
                  options=['slit', 'gisans', 'pinhole'],
                  width=6.5, height=9),
            ),
