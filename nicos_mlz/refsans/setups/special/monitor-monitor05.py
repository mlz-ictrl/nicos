...
_temp = Column(
    Block('Temperatures', [
        ...
        BlockRow(
            #Field(name='RACK3 so NL-Halle', dev='Temperature2', width=7),
            Field(name='choppercore 1', dev='chopper1_temp', width=7),
            Field(name='choppercore 2', dev='chopper2_temp', width=7),
            Field(name='choppercore 3', dev='chopper3_temp', width=7),
            Field(name='choppercore 4', dev='chopper4_temp', width=7),
        ),
        ],
    ),
)
