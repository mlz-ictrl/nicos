...
devices = dict(
    bs1r_motor = device(code_base + 'ipc.NOKMotorIPC',
        ...
        abslimits = (-173.0, 17.0), #2024-03-25 gap (-176.2, 13.6), #MP 2021-03-29 13:58:55 (-178.0, 11.8),
        bus = 'nokbus4',
        addr = 0x67,
        slope = 800.0,
        speed = 50,
        ...
        ramptype = 2,
        microstep = 1,
        refpos = -35.8, #2024-03-11 gap -41.8
    ...
    bs1s_motor = device(code_base + 'ipc.NOKMotorIPC',
        ...
        abslimits = (-183.002, 135.5), #2024-03-25 gap (-177.002, 139.998),
        bus = 'nokbus4',
        addr = 0x68,
        slope = 800.0,
        speed = 50,
        ...
        ramptype = 2,
        microstep = 1,
        refpos = 83.529, #2024-03-11 gap 89.529
        precision = optic_values['precision_ipcsms'],
    ...
    zb3r_motor = device(code_base + 'ipc.NOKMotorIPC',
        ...
        abslimits = (-216.0, 101.0), #2024-03-25 gap (-221.0, 95.0)
        bus = 'nokbus3',
        addr = 0x57,
        slope = 800.0,
        speed = 50,
        ...
        ramptype = 2,
        microstep = 1,
        refpos = 78.774, # 2024-03-11 gap 72.774,
        precision = optic_values['precision_ipcsms'],
    ...
    zb3s_motor = device(code_base + 'ipc.NOKMotorIPC',
        ...
        abslimits = (-112.0, 108.5), #2024-03-25 gap (-106.0, 113.562)
        bus = 'nokbus3',
        addr = 0x58,
        slope = 800.0,
        speed = 50,
        ...
        ramptype = 2,
        microstep = 1,
        refpos = 99.837, # 2024-03-11 gap 105.837,
        precision = optic_values['precision_ipcsms'],
