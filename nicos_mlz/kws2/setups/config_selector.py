...
#    '6A tilt':    dict(lam=6,    spread=0.2, speed=11374, tilted=True),
#    '6A':         dict(lam=6.19, spread=0.1, speed=21149, tilted=False),
    '7A':         dict(lam=7,    spread=0.1, speed=18102, tilted=False),
#    '7A tilt':    dict(lam=7,    spread=0.2, speed=9602,  tilted=True),
#    '8A':         dict(lam=8,    spread=0.1, speed=15823, tilted=False),
