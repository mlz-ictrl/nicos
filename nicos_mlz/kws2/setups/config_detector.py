...
##########################################################################
    ...
    '5A': {
        ...
        '2m':      dict(z=2,    x=1.0,  y=521.0),
        '4m':      dict(z=4,    x=2.0,  y=521.0),
#       '6m':      dict(z=6,    x=16.0,  y=603.6),
        '8m':      dict(z=8,    x=2.0,  y=519.5),
#x=21.5,  y=594.0),
        '8m DB':   dict(z=8,    x=2.0,  y=620.0, attenuator='in'),
#       '8m att':  dict(z=8,    x=13.0,  y=500.0),
        '20m':     dict(z=19.9, x=4.0,  y=511.0),
...
#       '8m att':  dict(z=8,    x=13.0,  y=500.0),
    ...
    '7A': {
        ...
        '1.5m DB': dict(z=1.5,  x=18.8,  y=500.0, attenuator='in'),
        '2m':      dict(z=2,    x=4.0,  y=524.0),
#       '2m DB':   dict(z=2,    x=16.9,  y=500.0, attenuator='in'),
        '4m':      dict(z=4,    x=6.0,  y=524.0),
...
# only 20 m have been updated at lambda = 10 A
    ...
    '10A': {
        ...
        '20m':     dict(z=19.9, x=4.0,  y=493.0),
        '20m DB':  dict(z=19.9, x=4.0,  y=620.0, attenuator='in'),
        'Small':   dict(det='small', x=0.0, y=711.4),
    },
    '11.3A': {
#       '2m':      dict(z=2,    x=18.8,  y=597.8),
