...
#       '8m att':  dict(z=8,    x=13.0,  y=500.0),
    ...
    '4.66A': {
        '1.5m':    dict(z=1.5,  x=17.0,  y=620),
        '1.5m DB': dict(z=1.5,  x=18.8,  y=500.0, attenuator='in'),
        '2m':      dict(z=2,    x=17,    y=622.0),
        '4m':      dict(z=4,    x=19.5,  y=597.5),
        '8m DB':   dict(z=8,    x=13.0,  y=500.0, attenuator='in'),
        '8m':      dict(z=8,    x=17.0,  y=621),
        '20m':     dict(z=19.9, x=20.0,  y=615),
        'Small':   dict(det='small', x=0.0, y=711.4),
##########################################################################
############################# ACHTUNG ####################################
...
##########################################################################
    ...
    '5A': {
        '1.5m':    dict(z=1.5,  x=17.0,  y=622.5),
        '1.5m DB': dict(z=1.5,  x=18.8,  y=500.0, attenuator='in'),
        '2m':      dict(z=2,    x=18.0,  y=622.0),
        '4m':      dict(z=4,    x=19.5,  y=623.0),
#       '6m':      dict(z=6,    x=16.0,  y=603.6),
        '8m':      dict(z=8,    x=20.5,  y=622.0),
#x=21.5,  y=594.0),
        '8m DB':   dict(z=8,    x=13.0,  y=500.0, attenuator='in'),
#       '8m att':  dict(z=8,    x=13.0,  y=500.0),
        '20m':     dict(z=19.9, x=21.0,  y=615.0),
        '20m DB':  dict(z=19.9, x=13.0,  y=400.0, attenuator='in'),
        'Small':   dict(det='small', x=0.0, y=711.4),
    },
    '5A tilt': {
...
#       '8m att':  dict(z=8,    x=13.0,  y=500.0),
    ...
    '7A': {
        '1.5m':    dict(z=1.5,  x=17.0,  y=620.0),
        '1.5m DB': dict(z=1.5,  x=18.8,  y=500.0, attenuator='in'),
        '2m':      dict(z=2,    x=17.0,  y=622.0),
#       '2m DB':   dict(z=2,    x=16.9,  y=500.0, attenuator='in'),
        '4m':      dict(z=4,    x=17.0,  y=622.5),
        '8m':      dict(z=8,    x=18.0,  y=620.0),
        '20m DB':  dict(z=19.9, x=13.0,  y=500.0, attenuator='in'),
        '20m':     dict(z=19.9, x=15.5,  y=606.0),
        'Small':   dict(det='small', x=-25.0, y=714.0),
    },
    '7A tilt': {
        '1.5m':    dict(z=1.5,  x=18.8,  y=596.8),
        '1.5m DB': dict(z=1.5,  x=18.8,  y=500.0, attenuator='in'),
...
#       '2m DB':   dict(z=2,    x=16.9,  y=500.0, attenuator='in'),
        ...
        'Small':   dict(det='small', x=-7.0, y=700),
    },
    '8A': {
...
# only 20 m have been updated at lambda = 10 A
    ...
    '10A': {
        ...
        '4m':      dict(z=4,    x=19.0,  y=594.5),
        '8m':      dict(z=8,    x=16.0,  y=595.0),
        '8m DB':   dict(z=8,    x=13.0,  y=500.0, attenuator='in'),
        '20m':     dict(z=19.9, x=20.0,  y=594.5),
        '20m DB':  dict(z=19.9, x=13.0,  y=500.0, attenuator='in'),
        'Small':   dict(det='small', x=0.0, y=711.4),
    },
    '11.3A': {
...
#       '20m':     dict(z=19.9, x=21.5,  y=567.2),
    ...
    '19A': {
        '2m':      dict(z=2,    x=18.8,  y=597.8),
        '20m':     dict(z=19.9, x=16.0,  y=400.0),
