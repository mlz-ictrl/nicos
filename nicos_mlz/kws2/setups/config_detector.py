...
##########################################################################
    ...
    '5A': {
        '1.5m':    dict(z=1.5,  x=16.0,  y=600.0),
        '1.5m DB': dict(z=1.5,  x=18.8,  y=500.0, attenuator='in'),
        '2m':      dict(z=2,    x=16.0,  y=601.5),
        '4m':      dict(z=4,    x=16.0,  y=601.5),
#       '6m':      dict(z=6,    x=16.0,  y=603.6),
        '8m':      dict(z=8,    x=17.0,  y=600.5),
#x=21.5,  y=594.0),
        '8m DB':   dict(z=8,    x=13.0,  y=500.0, attenuator='in'),
#       '8m att':  dict(z=8,    x=13.0,  y=500.0),
        '20m':     dict(z=19.9, x=19.0,  y=594.0),
        '20m DB':  dict(z=19.9,x=13.0,  y=500.0, attenuator='in'),
        'Small':   dict(det='small', x=0.0, y=711.4),
    },
    '5A tilt': {
        '1.5m':    dict(z=1.5,  x=19.0,  y=596.5),
        '2m':      dict(z=2,    x=15.6,  y=602.0),
        '2m DB':   dict(z=2,    x=13.0,  y=500.0, attenuator='in'),
        '4m':      dict(z=4,    x=13.7,  y=602.0),
#       '6m':      dict(z=6,    x=16.0,  y=603.6),
        '8m':      dict(z=8,    x=16.0,  y=600.0),
        '8m DB':   dict(z=8,    x=13.0,  y=500.0, attenuator='in'),
#       '8m att':  dict(z=8,    x=13.0,  y=500.0),
...
#       '2m DB':   dict(z=2,    x=16.9,  y=500.0, attenuator='in'),
        '4m':      dict(z=4,    x=16.0,  y=601.5),
        '8m':      dict(z=8,    x=16.0,  y=599.5),
        '8m DB':   dict(z=8,    x=20.0,  y=500.0, attenuator='in'),
        '20m':     dict(z=19.9, x=19.0,  y=587.0),
        'Small':   dict(det='small', x=-13.00, y=712.5),
    },
    '7A tilt': {
        '1.5m':    dict(z=1.5,  x=18.8,  y=596.8),
        '1.5m DB': dict(z=1.5,  x=18.8,  y=500.0, attenuator='in'),
...
# only 20 m have been updated at lambda = 10 A
    ...
    '10A': {
        ...
        '4m':      dict(z=4,    x=16.0,  y=600.0),
        '8m':      dict(z=8,    x=16.0,  y=595.0),
        '8m DB':   dict(z=8,    x=13.0,  y=500.0, attenuator='in'),
        '20m':     dict(z=19.9, x=20.0,  y=574.5),
        '20m DB':   dict(z=19.9,    x=13.0,  y=500.0, attenuator='in'),
#y=568.5),
        'Small':   dict(det='small', x=0.0, y=711.4),
    },
