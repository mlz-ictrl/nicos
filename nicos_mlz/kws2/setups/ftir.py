...
devices = dict(
    ftir_pol_rot = device('nicos.devices.tango.Motor',
    ...
    ftir_pol_tbl = device('nicos.devices.tango.Motor',
    ...
    ftir_sample_tbl = device('nicos.devices.tango.Motor',
    ...
    FTIR = device('nicos_mlz.kws2.devices.ftir.FTIRSpectro',
        ...
        trigger_out = device('nicos.devices.tango.DigitalOutput',
            tangodevice = tango_base + 'lj/trigger',
        ),
        status_in = device('nicos.devices.tango.DigitalInput',
            tangodevice = tango_base + 'lj/status',
        ),
        fileno_in = device('nicos.devices.tango.DigitalInput',
