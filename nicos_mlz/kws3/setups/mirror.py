...
devices = dict(
    mir_x = device('nicos.devices.entangle.Motor',
    ...
    mir_y = device('nicos.devices.entangle.Motor',
    ...
    mir_tilt = device('nicos.devices.entangle.Motor',
    ...
    mir_pos = device('nicos_mlz.kws3.devices.combined.Mirror',
    ...
    mir_ap1_x_left = device('nicos.devices.entangle.Motor',
    ...
    mir_ap1_x_right = device('nicos.devices.entangle.Motor',
    ...
    mir_ap1_y_upper = device('nicos.devices.entangle.Motor',
    ...
    mir_ap1_y_lower = device('nicos.devices.entangle.Motor',
    ...
    mir_ap2_x_left = device('nicos.devices.entangle.Motor',
    ...
    mir_ap2_x_right = device('nicos.devices.entangle.Motor',
    ...
    mir_ap2_y_upper = device('nicos.devices.entangle.Motor',
    ...
    mir_ap2_y_lower = device('nicos.devices.entangle.Motor',
