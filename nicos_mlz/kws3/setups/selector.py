...
devices = dict(
    ...
    sel_speed_valid = device('nicos.devices.entangle.DigitalOutput',
        tangodevice = tango_base + 's7_digital/sel_speed_valid',
        lowlevel = True,
    ),
    sel_speed_status = device('nicos.devices.entangle.DigitalInput',
        tangodevice = tango_base + 's7_digital/sel_speed_status',
        lowlevel = True,
    ),
    sel_speed_raw = device('nicos.devices.entangle.AnalogOutput',
