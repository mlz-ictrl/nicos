...
devices = dict(
    ...
    sam_hub_x = device('nicos.devices.entangle.Motor',
    ...
    sam_hub_y = device('nicos.devices.entangle.Motor',
    ...
    sam_hub_mobil_y = device('nicos.devices.entangle.Motor',
    ...
    sam10_x = device('nicos.devices.entangle.Motor',
    ...
    sam10_y = device('nicos.devices.entangle.Motor',
    ...
    sam10_ap_x_left = device('nicos.devices.entangle.Motor',
    ...
    sam10_ap_x_right = device('nicos.devices.entangle.Motor',
    ...
    sam10_ap_y_upper = device('nicos.devices.entangle.Motor',
    ...
    sam10_ap_y_lower = device('nicos.devices.entangle.Motor',
    ...
    sam01_x = device('nicos.devices.entangle.Motor',
    ...
    sam01_y = device('nicos.devices.entangle.Motor',
    ...
    sam01_ap_x_left = device('nicos.devices.entangle.Motor',
    ...
    sam01_ap_x_right = device('nicos.devices.entangle.Motor',
    ...
    sam01_ap_y_upper = device('nicos.devices.entangle.Motor',
    ...
    sam01_ap_y_lower = device('nicos.devices.entangle.Motor',
