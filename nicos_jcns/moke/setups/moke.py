...
devices = {
    'Intensity': device('nicos_jcns.moke.devices.moke.MokeVoltmeter',
    ...
    'MagB': device('nicos_jcns.moke.devices.moke.MokeMagnet',
    ...
    'Mag_sensor': device('nicos_jcns.moke.devices.moke.MokeTeslameter',
    ...
    'PS_current': device('nicos_jcns.moke.devices.moke.MokePowerSupply',
    ...
    'PS_voltage': device('nicos_jcns.moke.devices.moke.MokePSVoltage',
