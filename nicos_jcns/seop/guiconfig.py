...
main_window = docked(
    tabbed(
        ...
        ('Settings',
            panel('nicos_jcns.seop.gui.seop.SeopSettingsPanel')
        ),
        ('Ocean HR4000',
            panel('nicos_jcns.seop.gui.seop.SpectrometerPanel')
        ),
    ),
    ('NICOS devices',
        panel(
...
tools = [
    ...
    tool(
        'Seop Quick Buttons', # 'polarization',
