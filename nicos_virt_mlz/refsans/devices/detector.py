...
class McStasSimulation(BaseSimulation):
    ...
    attached_devices = {
        ...
        'top_gonio_z': Attach('Top goniometer (z)', Readable,
                              optional=True),
    ...
    def _prepare_params(self):
        return [
            ...
            'b1_h=%s' % self._dev(self._attached_b1.height),
            ...
            'zb3_h=%s' % self._dev(self._attached_zb3.height),
            'bs1_c=%s' % self._dev(self._attached_bs1.center),
            'bs1_h=%s' % self._dev(self._attached_bs1.height),
            'h3_c=%s' % self._dev(self._attached_h3.center),
            'h3_w=%s' % self._dev(self._attached_h3.height),
            'b3_c=%s' % self._dev(self._attached_b3.center),
            'b3_h=%s' % self._dev(self._attached_b3.height),
            ...
            'top_gonio_z=%s' % self._dev(self._attached_top_gonio_z,
                                         default='0'),
