...
class McStasSimulation(BaseSimulation):
    ...
    attached_devices = {
        ...
        'hrf_0b': Attach('Current of second rf-flipper static field',
                         Readable),
    ...
    def _prepare_params(self):
        params = [
            'lam=%s' % self._dev_value(self._attached_l_ambda),
            'dlam=%.2f' % (self._attached_d_lambda.read(0) *
                           self._attached_l_ambda.read(0) / 100),
            'table_x=%s' % self._dev_value(self._attached_tablex),
            'table_y=%s' % self._dev_value(self._attached_tabley),
            'table_z=%s' % self._dev_value(self._attached_tablez),
            'table_rotx=%s' % self._dev_value(self._attached_table_rotx),
            'table_roty=%s' % self._dev_value(self._attached_table_roty),
            'table_rotz=%s' % self._dev_value(self._attached_table_rotz),
            'l1=%s' % self._dev_value(self._attached_l1),
            'l2=%s' % self._dev_value(self._attached_l2),
            'nse0=%s' % self._dev_value(self._attached_nse0),
            'arm2_rot=%s' % self._dev_value(self._attached_arm2_rot),
            'samplenum=%d' % self._attached_sample.sampletype,
            'mathmode=%s' % self._dev_value(self._attached_mathmode),
            'cbox_0a_fg_freq=%s' % self._dev_value(
                self._attached_cbox_0a_fg_freq),
            'cbox_0b_fg_freq=%s' % self._dev_value(
                self._attached_cbox_0b_fg_freq),
            'psd_dist=%s' % self._dev_value(self._attached_psd_distance),
            'hrf_0a=%s' % self._dev_value(self._attached_hrf_0a),
            'hrf_0b=%s' % self._dev_value(self._attached_hrf_0b),
            'gf0=%s' % self._dev_value(self._attached_gf0),
            'gf1=%s' % self._dev_value(self._attached_gf1),
            'gf2=%s' % self._dev_value(self._attached_gf2),
            'gf4=%s' % self._dev_value(self._attached_gf4),
            'gf5=%s' % self._dev_value(self._attached_gf5),
            'gf6=%s' % self._dev_value(self._attached_gf6),
            'gf7=%s' % self._dev_value(self._attached_gf7),
            'gf8=%s' % self._dev_value(self._attached_gf8),
            'gf9=%s' % self._dev_value(self._attached_gf9),
            'gf10=%s' % self._dev_value(self._attached_gf10),
            'hsf_0a=%s' % self._dev_value(self._attached_hsf_0a),
            'hsf_0b=%s' % self._dev_value(self._attached_hsf_0b),
            'sf_0a=%s' % self._dev_value(self._attached_sf_0a),
            'sf_0b=%s' % self._dev_value(self._attached_sf_0b),
