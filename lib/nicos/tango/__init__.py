...
from nicos.tango.core import TangoDevice
from nicos.tango.frm2device import FRM2Device
from nicos.tango.io import AnalogInput, AnalogOutput, DigitalInput, \
     NamedDigitalInput, PartialDigitalInput, DigitalOutput, \
     NamedDigitalOutput, PartialDigitalOutput, BitsDigitalOutput, \
     MultiDigitalOutput
from nicos.tango.temperature import TemperatureSensor, TemperatureController
