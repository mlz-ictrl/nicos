...
class GracePlot:
    ...
    def __init__(self, width=None, height=None, auto_redraw=True,
                 redraw_interval=0.1, workingdir=None):
        ...
        def preexec():
            os.setpgrp()  # avoid Ctrl-C signals from console reaching process
            if workingdir:
                os.chdir(workingdir)
        ...
        # start up a thread to send data, so main thread does not block waiting
        # to draw
