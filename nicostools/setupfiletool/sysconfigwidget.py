...
from nicos.guisupport.qt import QMenu, QMessageBox, QTreeWidgetItem, pyqtSignal

from .dialogs import NewValueDialog
from .utilities.treewidgetcontextmenu import TreeWidgetContextMenu
...
class SysconfigWidget(TreeWidgetContextMenu):
    ...
    def __init__(self, parent=None):
        ...
        # the others, 'datasinks' and 'notifiers', allow multiple values.
