...
devices = dict(
    ...
    ls336_003_HTR1_RAMP_RATE=device(
        'nicos.devices.epics.EpicsAnalogMoveable',
    ...
    ls336_003_HTR2_RAMP_RATE=device(
        'nicos.devices.epics.EpicsAnalogMoveable',
