...
devices=dict(
    subcryo_state=device('nicos_ess.devices.epics.extensions.EpicsMappedMoveable',
    ...
    T_subcryo_setpoint=device('nicos_ess.devices.epics.base.EpicsAnalogMoveableEss',
        description='The setpoint for the sub cryo',
        readpv='{}SUBCRYO_SETP'.format(pv_root),
        writepv='{}SUBCRYO_SETP_S'.format(pv_root),
        abslimits=(0.0, 400),
    ),
    T_maincryo_setpoint=device('nicos_ess.devices.epics.base.EpicsAnalogMoveableEss',
    ...
    subcryo_mode=device('nicos_ess.devices.epics.extensions.EpicsMappedMoveable',
    ...
    T_subcryo_setpoint_min=device('nicos_ess.devices.epics.base.EpicsReadableEss',
        description='The minimum value for the setpoint',
        readpv='{}SUBCRYO_SETP_MIN'.format(pv_root),
        lowlevel=True,
    ),
    T_subcryo_setpoint_max=device('nicos_ess.devices.epics.base.EpicsReadableEss',
