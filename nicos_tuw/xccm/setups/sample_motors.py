...
devices = dict(
    sample_Ty_m = device('nicos.devices.tango.Motor',
    ...
    sample_Tz_m = device('nicos.devices.tango.Motor',
    ...
    sample_Rx_m = device('nicos.devices.tango.Motor',
    ...
    sample_Ry_m = device('nicos.devices.tango.Motor',
    ...
    # sample_Rot_y_c = device('nicos.devices.tango.Sensor',
    ...
    sample_Rz_m = device('nicos.devices.tango.Motor',
