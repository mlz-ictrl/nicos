...
class RNPPanel(Panel):
    ...
    def __init__(self, parent, client, options):
        ...
        loadUi(self, findResource('nicos_lahn/v6/gui/rnppanel_2.ui'))
    ...
    def changed_sliders(self):
        changed_sliders = {
            ...
            'phi_m': (self.phi_m, self.phi_m_value),
            'omega_m': (self.omega_m, self.omega_m_value),
            'high_m': (self.high_m, self.high_m_value),
            'high_be': (self.high_be, self.high_be_value),
    ...
    def on_start_clicked(self):
        code = [
            ...
            'maw(lin_m, %r, phi_m, %r, omega_m, %r, high_m, %r)' %
            (self.lin_m_value.text(), self.phi_m_value.text(),
             self.omega_m_value.text(), self.high_m_value.text()),
            'move(high_be, %r)' % self.high_be_value.text(),
            'maw(slit_1, [%r, %r, %r, %r])' %
