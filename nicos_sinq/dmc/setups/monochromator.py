...
devices = dict(
    a1 = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    a2 = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    mtl = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    mtu = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    mgl = device('nicos_sinq.devices.epics.motor.EpicsMotor',
        description = 'Monochromator goniometer lower',
        motorpv = f'{pvprefix}MGL',
        errormsgpv = f'{pvprefix}MGL-MsgTxt',
        can_disable = True,
    ),
    mgu = device('nicos_sinq.devices.epics.motor.EpicsMotor',
