...
devices = dict(
    scx = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
        description = 'SCX',
    ...
    scy = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
        description = 'SCY',
    ...
    sgx = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
    ...
    sgy = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
    ...
    sth = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
