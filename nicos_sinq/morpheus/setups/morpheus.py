...
devices = dict(
    ...
    som = device('nicos.devices.generic.DeviceAlias', alias = 'sth', visibility=['metadata', 'namespace', 'devlist']),
    s2t = device('nicos.devices.generic.DeviceAlias', alias = 'stt', visibility=['metadata', 'namespace', 'devlist']),
