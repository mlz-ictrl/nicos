...
devices = dict(
    afc = device('nicos_ess.devices.epics.base.EpicsAnalogMoveableEss',
        epicstimeout = 3.0,
    ...
    pfc = device('nicos_ess.devices.epics.base.EpicsAnalogMoveableEss',
        epicstimeout = 3.0,
    ...
    pff = device('nicos_ess.devices.epics.base.EpicsAnalogMoveableEss',
        epicstimeout = 3.0,
        description = 'Polarizer magnet',
    ...
    sbz = device('nicos_ess.devices.epics.base.EpicsAnalogMoveableEss',
        epicstimeout = 3.0,
    ...
    spin = device('nicos_sinq.morpheus.devices.spin.MorpheusSpin',
        description = 'Spin control for MORPHEUS',
        afc = 'afc',
    ),
)
