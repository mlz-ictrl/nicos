...
devices = dict(
    ...
    d3r = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
    ...
    d3l = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
    ...
    dxb = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
    ...
    dxt = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        epicstimeout = 3.0,
    ...
    sps = device('nicos_sinq.devices.epics.extensions.EpicsCommandReply',
        epicstimeout = 3.0,
