...
devices = dict(
    brle = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    brri = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    brto = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    brbo = device('nicos_sinq.devices.epics.motor.EpicsMotor',
