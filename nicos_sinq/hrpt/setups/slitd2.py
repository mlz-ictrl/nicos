...
devices = dict(
    brle = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
    ...
    brri = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
    ...
    brto = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
    ...
    brbo = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
