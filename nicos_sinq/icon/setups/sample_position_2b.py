...
devices = dict(
    sp2b_tx = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
    ...
    sp2b_ry = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
        description = 'Sample position 2b, Rotation Y-axis',
        motorpv = pvprefix + 'sp2b_ry',
        errormsgpv = pvprefix + 'sp2b_ry-MsgTxt',
        precision = 0.01,
    ),
    sp2b_rz = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
