...
devices = dict(
    bl2left = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
    ...
    bl2right = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
        description = 'Beam limiter 2 +X',
    ...
    bl2bottom = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
    ...
    bl2top = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
        description = 'Beam limiter 2 +Y',
