...
devices = dict(
    sp2_tx = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
        description = 'Sample Position 2, Translation X',
        motorpv = 'SQ:ICON:board3:SP2TX',
        errormsgpv = 'SQ:ICON:board3:SP2TX-MsgTxt',
        precision = 0.01,
    ),
    sp2_ty_axis = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
    ...
    sp2_tz = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
        description = 'Sample Position 2, Translation Z',
        motorpv = 'SQ:ICON:board3:SP2TZ',
        errormsgpv = 'SQ:ICON:board3:SP2TZ-MsgTxt',
        precision = 0.01,
    ),
    sp2_rx = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
    ...
    sp2_rz = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
