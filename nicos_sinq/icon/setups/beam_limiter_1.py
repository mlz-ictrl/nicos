...
devices = dict(
    bl1left = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
    ...
    bl1right = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
        description = 'Beam limiter 1 +X',
    ...
    bl1bottom = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
    ...
    bl1top = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
        description = 'Beam limiter 1 +Y',
