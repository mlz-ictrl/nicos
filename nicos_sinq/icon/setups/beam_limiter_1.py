...
devices = dict(
    bl1left = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
    ...
    bl1right = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        description = 'Beam limiter 1 +X',
    ...
    bl1bottom = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
    ...
    bl1top = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        description = 'Beam limiter 1 +Y',
