...
devices = dict(
    ...
    sp3_tx = device('nicos_sinq.icon.devices.iconmotor.EnabledMotor',
    ...
    sp3_ty_axis = device('nicos_sinq.icon.devices.iconmotor.EnabledMotor',
    ...
    sp3_ry = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
        description = 'Sample Position 3, Rotation Y',
        motorpv = 'SQ:ICON:board6:SP3RY',
        errormsgpv = 'SQ:ICON:board6:SP3RY-MsgTxt',
        precision = 0.01,
    ),
    sp3_rz = device('nicos_sinq.icon.devices.iconmotor.HomingProtectedEpicsMotor',
