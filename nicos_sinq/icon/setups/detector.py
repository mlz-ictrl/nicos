...
devices = dict(
    cam_shut = device('nicos_sinq.icon.devices.epics_devices.EpicsReadable',
        description = 'Camera shutter open',
        readpv = pvprefix + 'SHUTTER',
        visibility = (),
    ),
    cam_arm = device('nicos_sinq.icon.devices.epics_devices.EpicsReadable',
        description = 'Camera ready for acquisition',
        readpv = pvprefix + 'ARM',
        visibility = (),
    ),
    cam_trig = device('nicos_sinq.icon.devices.epics_devices.EpicsDigitalMoveable',
    ...
    cam_valid = device('nicos_sinq.icon.devices.epics_devices.EpicsDigitalMoveable',
