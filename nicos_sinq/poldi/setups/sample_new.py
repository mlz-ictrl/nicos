...
devices = dict(
    sa=device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
               description='Sample table rotation',
               motorpv=f'{pvprefix}SA-NZE',
               ),
    shl=device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
               description='Sample table X translation',
               motorpv=f'{pvprefix}SHL-NE',
               ),
    shu=device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
               description='Sample table Y translation',
               motorpv=f'{pvprefix}SHU-NE',
               ),
    sv=device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
