...
devices = dict(
    ...
    tube_array = device('nicos_sinq.devices.sinqhm.configurator.HistogramConfArray',
        description = 'Array of tubes',
        lowlevel = True,
        tag = 'tubes',
        formatter = '%9d',
        dim = [
    ...
    pixel_array = device('nicos_sinq.devices.sinqhm.configurator.HistogramConfArray',
        description = 'TOF Array for histogramming',
        lowlevel = True,
        tag = 'pixels',
        formatter = '%9d',
