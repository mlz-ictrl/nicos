...
devices = dict(
    ch1_speed=device('nicos_sinq.devices.epics.astrium_chopper.EpicsChopperSpeed',
        description='Speed controller for the main chopper',
        epicstimeout=3.0,
    ...
    ch1=device('nicos_sinq.devices.epics.astrium_chopper.EpicsChopperDisc',
        description='Chopper main',
        epicstimeout=3.0,
        basepv=pvprefix + 'ch1',
        speed='ch1_speed',
    ),
    ch2_phase=device('nicos_ess.devices.epics.base.EpicsWindowTimeoutDeviceEss',
        description='Phase controller for the subordinate chopper 2',
        epicstimeout=3.0,
    ...
    ch2_ratio=device('nicos_ess.devices.epics.base.EpicsDigitalMoveableEss',
        description='Ratio controller for the subordinate chopper',
        epicstimeout=3.0,
    ...
    ch2=device('nicos_sinq.devices.epics.astrium_chopper.EpicsChopperDisc',
        description='Chopper subordinate',
        epicstimeout=3.0,
        basepv=pvprefix + 'ch2',
        phase='ch2_phase',
        ratio='ch2_ratio',
