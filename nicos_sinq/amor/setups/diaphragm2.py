...
devices = dict(
    d2t = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    d2b = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    d2l = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    d2r = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    d2z = device('nicos_sinq.devices.epics.motor.EpicsMotor',
