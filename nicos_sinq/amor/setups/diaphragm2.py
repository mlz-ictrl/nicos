...
devices = dict(
    d2t = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Slit 2 top blade',
        motorpv = pvprefix + 'd2t',
        visibility = ('devlist', 'metadata', 'namespace'),
    ),
    d2b = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
    ...
    d2z = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
