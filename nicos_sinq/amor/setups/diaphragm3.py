...
devices = dict(
    d3t = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
    ...
    d3b = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
    ...
    d3z = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
