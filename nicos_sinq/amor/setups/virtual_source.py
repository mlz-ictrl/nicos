...
devices = dict(
    ...
    dvv_motor = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    dvh_motor = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    dmf_motor = device('nicos_sinq.devices.epics.motor.EpicsMotor',
