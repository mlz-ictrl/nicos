...
devices = dict(
    ...
    dvv_motor = device('nicos.devices.epics.pyepics.motor.EpicsMotor',
    ...
    dvh_motor = device('nicos.devices.epics.pyepics.motor.EpicsMotor',
    ...
    dmf_motor = device('nicos.devices.epics.pyepics.motor.EpicsMotor',
        description = 'Diaphragm virtual Source Vertical motor',
