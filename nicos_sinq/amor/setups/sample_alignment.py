...
devices = dict(
    ...
    sample_roll = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
                         description = 'adjust sample rotation normal to beam direction',
                         motorpv = pvprefix + 'sch',
                         fmtstr = '%6.1f',
                         unit = 'deg',
                         ),
    #sample_azimut = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
