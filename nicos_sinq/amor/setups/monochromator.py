...
devices = dict(
    mom=device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
               epicstimeout=3.0,
               description='Tilt monochromator motor',
               motorpv=pvprefix + 'mom',
               ),
    moz=device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
               epicstimeout=3.0,
               description='Monochromator z position of rotation axis motor',
               motorpv=pvprefix + 'moz',
               ),
    mtz=device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
               epicstimeout=3.0,
               description='Monochromator z position relative to rotation axis motor',
               motorpv=pvprefix + 'mtz',
               ),
    mty=device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
               epicstimeout=3.0,
