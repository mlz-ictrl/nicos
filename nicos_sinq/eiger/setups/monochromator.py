...
devices = dict(
    ...
    a2rot = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
    ...
    mt = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
    ...
    mg = device('nicos_sinq.devices.epics.motor_deprecated.EpicsMotor',
