...
devices = dict(
    ...
    a2rot = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    mt = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    mg = device('nicos_sinq.devices.epics.motor.EpicsMotor',
