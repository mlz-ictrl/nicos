...
devices = dict(
    ...
    a6 = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    tan = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    s2anr = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    s2anb = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    s2ant = device('nicos_sinq.devices.epics.motor.EpicsMotor',
    ...
    s2anl = device('nicos_sinq.devices.epics.motor.EpicsMotor',
