...
devices = dict(
    ...
    a6 = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Analyser two theta',
        motorpv = pvpref + 'A6',
    ),
    tan = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
    ...
    s2anr = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Analyser slit right',
        motorpv = snpref + 'S2ANR',
    ),
    s2anb = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Analyser slit bottom',
        motorpv = snpref + 'S2ANB',
    ),
    s2ant = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Analyser slit top',
        motorpv = snpref + 'S2ANT',
    ),
    s2anl = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
