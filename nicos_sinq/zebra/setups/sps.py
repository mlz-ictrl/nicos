...
devices = dict(
    ...
    pgbutton = device('nicos.devices.epics.EpicsDigitalMoveable',
    ...
    colbutton = device('nicos.devices.epics.EpicsDigitalMoveable',
        description = 'PG filter toggle',
