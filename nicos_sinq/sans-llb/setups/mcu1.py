description = 'Devices from Motor Controller mcu1'

pvprefix = 'SQ:SANS-LLB:mcu1:'

devices = dict(
    sl0yp = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl0yn = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl0xp = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl0xn = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        epicstimeout = 3.0,
    ...
    polpos = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        epicstimeout = 3.0,
    ...
    guide0pos = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        epicstimeout = 3.0,
        description = 'Guide 0  translation',
        motorpv = pvprefix + 'guide0',
        errormsgpv = pvprefix + 'guide0-MsgTxt',
        precision = 0.01,
    ),
    guide0 = device('nicos.devices.generic.switcher.Switcher',
        description = 'Guide 0 choice',
        moveable = 'guide0pos',
        mapping = {
            'out': 10,
            'in': 100,
    ...
    attpos = device('nicos.devices.epics.pyepics.motor.HomingProtectedEpicsMotor',
        epicstimeout = 3.0,
