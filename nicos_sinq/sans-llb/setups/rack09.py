...
devices = dict(
    sl1yp = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl1yn = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl1xp = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl1xn = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    guide1pos = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl2yp = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl2yn = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl2xp = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    sl2xn = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
    ...
    guide2pos = device('nicos_sinq.devices.epics.motor.AbsoluteEpicsMotor',
        epicstimeout = 3.0,
