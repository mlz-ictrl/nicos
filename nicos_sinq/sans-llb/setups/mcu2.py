...
devices = dict(
    sl0yn = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        epicstimeout = 3.0,
        description = 'Slit 0 Up',
        motorpv = pvprefix + 'sl0yn',
    ),
    sl0yp = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        epicstimeout = 3.0,
        description = 'Slit 0 down',
        motorpv = pvprefix + 'sl0yp',
    ),
    sl0xp = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        epicstimeout = 3.0,
        description = 'Slit 0 left',
        motorpv = pvprefix + 'sl0xp',
    ),
    sl0xn = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        epicstimeout = 3.0,
        description = 'Slit 0 right',
        motorpv = pvprefix + 'sl0xn',
    ),
    polpos = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        epicstimeout = 3.0,
