...
devices = dict(
    coll = device('nicos.devices.generic.MultiSwitcher',
        ...
        mapping = {
            ...
            '11750': ['in', 'in', 'in', 'out', 'out', 'out'],
            '15500': ['in', 'in', 'out', 'out', 'out', 'out'],
            '18500': ['in', 'out', 'out', 'out', 'out', 'out'],
        },
        precision = [None],
    ),
)
