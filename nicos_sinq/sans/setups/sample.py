...
devices = dict(
    z = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Sample Table Height',
        motorpv = pvprefix + 'z',
    ),
    xo = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Sample Table X Translation',
        motorpv = pvprefix + 'xo',
    ),
    yo = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Sample Table Y Translation',
        motorpv = pvprefix + 'yo',
    ),
    a3 = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Sample table Rotation',
        motorpv = pvprefix + 'a3',
    ),
    xu = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Sample Upper X Translation',
        motorpv = pvprefix + 'xu',
    ),
    sg = device('nicos_sinq.devices.epics.sinqmotor_deprecated.SinqMotor',
        description = 'Sample table Rotation',
        motorpv = pvprefix + 'sg',
    ),
