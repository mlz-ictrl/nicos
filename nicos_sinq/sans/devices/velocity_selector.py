...
def NVSSANS1(tilt):
    ...
    A = 0.01223 + (0.000360495 * xi) + (0.000313819 * tsq) + \
        (0.0000304937 * tter) + (0.000000931533 * tquat)

    B = 12721.11905 - (611.74127 * xi) - (12.44417 * tsq) - \
...
class VSLambda(Moveable):
    """
    SINQ uses a different way to calculate the wavelength than
    ...
    def _calcCoefficients(self):
        # the sign convention has changed after SINQ upgrade with the new MCU
