...
devices = dict(
    ...
    ieee1 = device('nicos_mlz.sans1.devices.IEEEDevice'),
    ieee2 = device('nicos_mlz.sans1.devices.IEEEDevice',
                   valuename = 'dev1'),
    ieee3 = device('nicos_mlz.sans1.devices.IEEEDevice',
    ...
    det1_z = device('nicos_mlz.sans1.devices.DetectorTranslation',
        device = 'det1_z_ax',
        lock = device('nicos_mlz.sans1.devices.VoltageSwitcher',
            moveable = device('nicos_mlz.sans1.devices.Sans1HV',
                unit = 'V',
                fmtstr = '%d',
    ...
    bs_xax = device('nicos_mlz.sans1.devices.BeamStopAxis',
        motor = 'bs_ax_motor',
        coder = 'bs_ax_motor',
        precision = 0.1,
        fmtstr = '%.2f',
    ...
    bs_yax = device('nicos_mlz.sans1.devices.BeamStopAxis',
        motor = 'bs_ay_motor',
        coder = 'bs_ay_motor',
        precision = 0.1,
        fmtstr = '%.2f',
    ),
    bs = device('nicos_mlz.sans1.devices.BeamStop',
        xaxis = 'bs_xax',
        yaxis = 'bs_yax',
        ypassage = -99,
        unit = 'mm',
