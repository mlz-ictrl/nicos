...
devices = dict(
    ...
    ieee1 = device('nicos_mlz.sans1.devices.ieee.IEEEDevice'),
    ieee2 = device('nicos_mlz.sans1.devices.ieee.IEEEDevice',
                   valuename = 'dev1'),
    ieee3 = device('nicos_mlz.sans1.devices.ieee.IEEEDevice',
    ...
    det1_z = device('nicos_mlz.sans1.devices.detector.DetectorTranslation',
        ...
        lock = device('nicos_mlz.sans1.devices.hv.VoltageSwitcher',
            moveable = device('nicos_mlz.sans1.devices.hv.HV',
                unit = 'V',
                fmtstr = '%d',
