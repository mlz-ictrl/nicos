...
devices = dict(
    ...
    aliasNoDev = device('devices.generic.DeviceAlias',
        alias = '',
        devclass = 'nicos.core.device.Readable',
    ),
    aliasDev = device('devices.generic.DeviceAlias',
        alias = '',
        devclass = 'devices.generic.VirtualMotor',
    ),
    aliasDev2 = device('devices.generic.DeviceAlias',
        alias = 'slit',
    ),
    aliasDev3 = device('devices.generic.DeviceAlias',
        alias = '',
    ),
    aliasDev4 = device('devices.generic.DeviceAlias',
        alias = '',
        devclass = 'devices.generic.VirtualMotor',
    ),
