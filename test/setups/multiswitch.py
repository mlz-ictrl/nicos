...
devices = dict(
    ...
    x_sw = device('devices.generic.Switcher',
        moveable = 'x',
        mapping = {'1': 594.5,
                   '2': 535.5,
                   '3': 476.5,
    ...
    y_sw = device('devices.generic.Switcher',
        moveable = 'y',
        mapping = {'top': 28.,
                   'bottom': -31.0},
        precision = 0.05,
    ...
    msw3 = device('devices.generic.MultiSwitcher',
        moveables = ['x', 'y', 'x'],
        mapping = {'1': [1, 0, 1]},
        precision = [0.05, 0.01]
    ),
    msw4 = device('devices.generic.MultiSwitcher',
        moveables = ['x', 'y', 'x'],
        mapping = {'1': [1, 0]},
        precision = [0.05, 0.01, 0.05]
    ),
    msw5 = device('devices.generic.MultiSwitcher',
        moveables = ['x', 'y', 'x'],
        mapping = {'1': [1, 0, 1],
                   '2': [0, 1, 0]},
        precision = [0.05, None, 0.05]
    ),
    mswfb = device('devices.generic.MultiSwitcher',
        moveables = ['x', 'y', 'x'],
        mapping = {'1': [1, 0, 1]},
