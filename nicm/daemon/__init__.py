...
from nicm.daemon.data import DataHandler
from nicm.daemon.util import ModuleManager
from nicm.daemon.script import ExecutionController
from nicm.daemon.handler import ConnectionHandler
...
class NicmDaemon(Device):
    ...
    def doInit(self):
        ...
        self._module_manager = ModuleManager(protect=['nicm.daemon.script',
                                                      'swig_runtime_data3',
                                                      'swig_runtime_data4'])
    ...
    def start(self):
        ...
        self.printinfo('nicm daemon v%s started, starting server on %s' %
                       (nicm_version, self.server))
