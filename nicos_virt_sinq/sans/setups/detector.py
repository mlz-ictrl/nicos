...
devices = dict(
    LivePNGSinkLog = device('nicos.devices.datasinks.PNGLiveFileSink',
        ...
        filename = 'data/html/live_log.png',
        log10 = True,
        interval = 15,
        detectors = ['sansdet']
    ),
    LivePNGSink = device('nicos.devices.datasinks.PNGLiveFileSink',
        description = 'Saves live image as .png every now and then',
        filename = 'data/html/live_lin.png',
        log10 = False,
        interval = 15,
        detectors = ['sansdet'],
    ),
    ...
    # ),
    sans_detector = device('nicos.devices.generic.VirtualImage',
...
for i in range(8):
    devices[f'monitor{i+1}'] = device('nicos.devices.generic.VirtualCounter',
