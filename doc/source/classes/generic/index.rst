...
All classes described here are re-exported in the :mod:`nicos.devices.generic` module,
so for example both ``nicos.devices.generic.Slit`` and ``nicos.devices.generic.slit.Slit`` are
valid entries for the class name in a setup file.
