...
copyright = '2009-present, FRM II / ' + author  # pylint: disable=redefined-builtin
...
rst_epilog = f'''
.. _latest development version: https://forge.frm2.tum.de/cgit/cgit.cgi/frm2/nicos/nicos.git/snapshot/nicos-core-{version}.tar.bz2
'''
