...
devices = dict(
    ro_y     = device('nicos.devices.tango.Motor',
                      description = 'ROY axis',
                      tangodevice = tango_base + 'fzjs7/ROY',
                      lowlevel = True,
                     ),
    roy      = device('nicos.devices.generic.Axis',
                      description = 'ROY axis',
                      motor = 'ro_y',
                      coder = 'ro_y',
                      offset = 0,
    ...
    ro_z     = device('nicos.devices.tango.Motor',
                      description = 'ROZ axis',
                      tangodevice = tango_base + 'fzjs7/ROZ',
                      lowlevel = True,
                     ),
    roz      = device('nicos.devices.generic.Axis',
                      description = 'ROZ axis',
                      motor = 'ro_z',
                      coder = 'ro_z',
                      offset = 0,
    ...
    dof_chi  = device('nicos.devices.tango.Motor',
                      description = 'DOFChi axis',
                      tangodevice = tango_base + 'fzjs7/DOFChi',
                      lowlevel = True,
                     ),
    dofchi   = device('nicos.devices.generic.Axis',
                      description = 'DOFChi axis',
                      motor = 'dof_chi',
                      coder = 'dof_chi',
                      offset = 0,
    ...
    dof_om   = device('nicos.devices.tango.Motor',
                      description = 'DOFOm axis',
                      tangodevice = tango_base + 'fzjs7/DOFOm',
                      lowlevel = True,
                     ),
    dofom    = device('nicos.devices.generic.Axis',
                      description = 'DOFOm axis',
                      motor = 'dof_om',
                      coder = 'dof_om',
                      offset = 0,
    ...
    rob_y    = device('nicos.devices.tango.Motor',
    ...
    rob_z    = device('nicos.devices.tango.Motor',
