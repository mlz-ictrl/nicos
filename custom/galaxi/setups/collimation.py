...
devices = dict(
    ...
    b1h      = device('devices.generic.Axis',
                      description = 'Collimation slit B1 Height',
                      motor = 'b1_h',
                      coder = 'b1_h',
                      precision = 0.01,
    ...
    b1b      = device('devices.generic.Axis',
                      description = 'Collimation slit B1 Width',
                      motor = 'b1_b',
                      coder = 'b1_b',
                      precision = 0.01,
    ...
    b1y      = device('devices.generic.Axis',
                      description = 'Collimation slit B1 Left Right',
                      motor = 'b1_y',
                      coder = 'b1_y',
                      precision = 0.01,
    ...
    b1z      = device('devices.generic.Axis',
                      description = 'Collimation slit B1 Up Down',
                      motor = 'b1_z',
                      coder = 'b1_z',
                      precision = 0.01,
    ...
    b2h      = device('devices.generic.Axis',
                      description = 'Collimation slit B2 Height',
                      motor = 'b2_h',
                      coder = 'b2_h',
                      precision = 0.01,
    ...
    b2b      = device('devices.generic.Axis',
                      description = 'Collimation slit B2 Width',
                      motor = 'b2_b',
                      coder = 'b2_b',
                      precision = 0.01,
    ...
    b2y      = device('devices.generic.Axis',
                      description = 'Collimation slit B2 Left Right',
                      motor = 'b2_y',
                      coder = 'b2_y',
                      precision = 0.01,
    ...
    b2z      = device('devices.generic.Axis',
                      description = 'Collimation slit B2 Up Down',
                      motor = 'b2_z',
                      coder = 'b2_z',
                      precision = 0.01,
    ...
    b3h      = device('devices.generic.Axis',
                      description = 'Collimation slit B3 Height',
                      motor = 'b3_h',
                      coder = 'b3_h',
                      precision = 0.01,
    ...
    b3b      = device('devices.generic.Axis',
                      description = 'Collimation slit B3 Width',
                      motor = 'b3_b',
                      coder = 'b3_b',
                      precision = 0.01,
    ...
    b3y      = device('devices.generic.Axis',
                      description = 'Collimation slit B3 Left Right',
                      motor = 'b3_y',
                      coder = 'b3_y',
                      precision = 0.01,
    ...
    b3z      = device('devices.generic.Axis',
                      description = 'Collimation slit B3 Up Down',
                      motor = 'b3_z',
                      coder = 'b3_z',
                      precision = 0.01,
