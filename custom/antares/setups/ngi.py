...
devices = dict(
    G0rz = device('nicos.devices.taco.Motor',
        speed = 2,
        unit = 'deg',
    ...
    G0ry = device('nicos.devices.taco.Motor',
        speed = 5,
        unit = 'deg',
    ...
    G0tx = device('nicos.devices.taco.Motor',
        speed = 1,
        unit = 'mm',
    ...
    G1rz = device('nicos.devices.taco.Motor',
        speed = 0.3,
        unit = 'deg',
    ...
    G1tz = device('nicos.devices.taco.Motor',
        speed = 5,
        unit = 'mm',
    ...
    G12rz = device('nicos.devices.taco.Motor',
        speed = 5,
        unit = 'deg',
