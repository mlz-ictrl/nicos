...
devices = dict(
    ...
    qm_ctr0 = device('devices.vendor.qmesydaq.Counter',
                     description = 'QMesyDAQ Counter0',
                     tacodevice = '//%s/test/qmesydaq/counter0' % nethost,
                     type = 'counter',
                     lowlevel = True,
                    ),
    qm_ctr1 = device('devices.vendor.qmesydaq.Counter',
    ...
    qm_timer = device('devices.vendor.qmesydaq.Timer',
                     description = 'QMesyDAQ Timer',
                     tacodevice = '//%s/test/qmesydaq/timer' % nethost,
                    ),
    qm_files = device('devices.vendor.qmesydaq.Filenames',
