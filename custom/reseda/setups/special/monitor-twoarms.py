...
_expcolumn = Column(
    Block('Experiment', [
        BlockRow(Field(name='Exp no.', key='info/number', width=7),
            Field(name='Exp title', key='info/titel', width=20, istext=True),
...
_motorblock = Block('Arm Motors', [
    BlockRow(Field(name='TwoTheta 1', dev='m1', unit='Deg'),
...
_sampletableblock = Block('Sample Table', [
    BlockRow(Field(name='Ty - M3', dev='m3', unit='mm'),
             Field(name='Tx - M4', dev='m4', unit='mm'),
            ),

    BlockRow(Field(name='gl - M5', dev='m5', unit='Deg'),
...
_frequenciesblock = Block('Frequencies', [
    BlockRow(Field(name='Arm 0 - F0', dev='F0', unit='Hz', width=8, format="%.0f"),
             Field(name='Arm 1 - F1', dev='F1', unit='Hz', width=8, format="%.0f"),
             Field(name='Arm 2 - F2', dev='F2', unit='Hz', width=8, format="%.0f"),
            ),
    BlockRow(Field(name='Arm 0 - RF0', dev='RF0', unit='V', width=8),
             Field(name='Arm 1 - RF1', dev='RF1', unit='V', width=8),
             Field(name='Arm 2 - RF2', dev='RF2', unit='V', width=8),
            ),
    BlockRow(Field(name='Arm 0 - Fu0', dev='Fu0', unit='A', width=8),
             Field(name='Arm 1 - Fu1', dev='Fu1', unit='A', width=8),
...
_phasecoilsblock = Block('NSE phase coils', [
...
_maincoilsblock = Block('NSE main coils', [
    BlockRow(Field(name='B22', dev='B31_c', unit='A', width=10, format="%.5f"),
             Field(name='B22', dev='B31_v', unit='V', width=10, format="%.5f"),
             Field(name='B4', dev='B41_c', unit='A', width=10, format="%.5f"),
             Field(name='B4', dev='B41_v', unit='V', width=10, format="%.5f"),
            ),
    ],
    setups='powersupply',
)

_powersupplyblock = Block('Power Supply', [
    BlockRow(Field(name='B6', dev='B52_c', unit='A', width=10),
...
_scatteringblock = Block('Scattering', [
...
_capacitanceblock = Block('Capacitance', [
...
_attenuatorsblock = Block('Attentuators', [
