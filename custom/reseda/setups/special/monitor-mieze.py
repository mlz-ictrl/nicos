...
_frequenciesblock = Block('Frequencies', [
    BlockRow(Field(name='Coil 2 - F0', dev='F0', unit='Hz', width=8, format="%.0f"),
             Field(name='Coil 1 - F1', dev='F1', unit='Hz', width=8, format="%.0f"),
             Field(name='Detector', dev='F2', unit='Hz', width=8, format="%.0f"),
            ),
    BlockRow(Field(name='Coil 2 - RF0', dev='RF0', unit='V', width=8),
             Field(name='Coil 1 - RF1', dev='RF1', unit='V', width=8),
             Field(name='Detector', dev='RF2', unit='V', width=8),
            ),
    BlockRow(Field(name='Coil 2 - Fu0', dev='Fu0', unit='A', width=8),
...
_attenuatorsblock = Block('Attenuators', [
...
_rightcolumn = Column(_scatteringblock, _motorblock, _sampletableblock,
                      _currentblock, _powersupplyblock,
                     )
