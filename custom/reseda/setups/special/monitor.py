...
_powersupplyblock = Block('Power supplies', [
    ...
    BlockRow(Field(name='b 9', dev='b62_c', unit='(A)', width=10, format="%.2f"),
...
_beamblock = Block('Beam properties', [
     BlockRow(
...
_sqtblock = Block('Kinematic parameters', [
