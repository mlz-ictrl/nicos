...
_motorblock = Block(
    'Motors',
    [BlockRow(Field(name='M1', dev='m1', unit='Deg'), Field(name='M2', dev='m2', unit='Deg'),
      Field(name='M3', dev='m3', unit='mm'), Field(name='M4', dev='m4', unit='mm')),
     BlockRow(Field(name='M5', dev='m5', unit='Deg'), Field(name='M6', dev='m6', unit='Deg'),
     Field(name='M7', dev='m7', unit='Deg')),
    ],
    'startup')  # this is the name of a setup that must be loaded in the
...
_tempblock = Block(
    ...
    [BlockRow(Field(key='t/setpoint', name='Setpoint'),
              Field(name='TA', dev='TA', unit='K'), Field(name='TB', dev='TB', unit='K'),
              Field(name='TC', dev='TC', unit='K'), Field(name='TD', dev='TD', unit='K')),
...
_rightcolumn = Column(_motorblock, _currentblock, _powersupplyblock,
                      _scatteringblock, _attentuatorsblock)

_leftcolumn = Column( _tempblock, _frequenciesblock, _capacitanceblock)
