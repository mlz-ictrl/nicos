...
devices = dict(
    ...
    cbox = device('reseda.cbox.CBoxResonanceFrequency',
        ...
        pa_revp = 'pa_revp',
        fg = 'fg_frequency',
        diplexer = device('devices.tango.DigitalOutput',
