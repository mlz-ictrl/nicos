...
devices = dict(
    ...
    sgx = device('nicos.devices.taco.Motor',
                   description = 'Sample goniometer: x',
                   tacodevice = '%s/husco1/motor5' % taco_base,
                   fmtstr = '%.3f',
                   ),
    sgy = device('nicos.devices.taco.Motor',
                   description = 'Sample goniometer: x',
