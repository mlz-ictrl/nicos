...
devices = dict(
    ...
    beamstop_x = device("kws1.virtual.Standin",
                        description = "beamstop translation X",
                       ),
    beamstop_y = device("kws1.virtual.Standin",
    ...
    det_z_mot  = device("kws1.virtual.Standin",
                        description = "detector translation Z",
                        lowlevel = True,
                       ),
    psd_x      = device("kws1.virtual.Standin",
                        description = "small detector translation X",
                       ),
    psd_y      = device("kws1.virtual.Standin",
