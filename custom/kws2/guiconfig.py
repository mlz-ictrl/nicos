...
main_window = tabbed(
    ('Instrument', docked(
        ...
        ('Experiment Info',
            ...
            ('Al Wide cells',       (9,  2, 'sam_trans_x', 26.6,  'sam_trans_y', 105)),
            ('Al Narrow cells',     (16, 2, 'sam_trans_x', 15,    'sam_trans_y', 105)),
            ('Al Round cells',      (10, 2, 'sam_trans_x', 24,    'sam_trans_y', 105)),
