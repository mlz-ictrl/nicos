...
devices = dict(
    ...
    omgs_s = device('nicos.devices.vendor.caress.Motor',
    ...
    xt_s = device('nicos.devices.vendor.caress.Motor',
                description = 'HWB XT',
                fmtstr = '%.2f',
                unit = 'mm',
                coderoffset = -1033.53,
    ...
    yt_s = device('nicos.devices.vendor.caress.Motor',
                description = 'HWB YT',
                fmtstr = '%.2f',
                unit = 'mm',
                coderoffset = -10242.9,
    ...
    zt_s = device('nicos.devices.vendor.caress.Motor',
                description = 'HWB ZT',
                fmtstr = '%.2f',
                unit = 'mm',
                coderoffset = -1022,
