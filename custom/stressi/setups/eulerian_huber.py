...
includes = ['aliases_chiphi', 'system', 'mux', 'monochromator', 'detector',
...
devices = dict(
    chis_eh = device('nicos.devices.vendor.caress.Motor',
    ...
    phis_eh = device('nicos.devices.vendor.caress.Motor',
