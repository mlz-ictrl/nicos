...
devices = dict(
    ...
    robx = device('nicos.devices.generic.Axis',
                  ...
                  motor = device('nicos_mlz.stressi.robot.RobotMotor',
                                 fmtstr = '%.2f',
                                 unit = 'mm',
    ...
    robj4 = device('nicos_mlz.stressi.robot.RobotMotor',
    ...
    robj5 = device('nicos_mlz.stressi.robot.RobotMotor',
    ...
    robj6 = device('nicos_mlz.stressi.robot.RobotMotor',
    ...
    roba_t = device('nicos_mlz.stressi.wavelength.TransformedMoveable',
