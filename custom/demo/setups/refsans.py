...
devices = dict(
    ...
    nok2 = device('refsans.nok_support.DoubleMotorNOK',
                  ...
                  backlash = -2,
                  motor_r = device('devices.generic.VirtualMotor',
                                   abslimits = (-22.36, 10.88),
                                   speed = 5,
                                   unit = 'mm',
                                  ),
                  motor_s = device('devices.generic.VirtualMotor',
    ...
    det_timer = device('devices.generic.VirtualTimer',
    ...
    vacuum_SFK = device('devices.generic.ManualMove',
                        description = 'Vacuum sensor in beam guide chamber',
                        default = 0.00012,
                        abslimits = (0, 1000),
                        unit = 'mbar',
                       ),
    vacuum_SR = device('devices.generic.ManualMove',
    ...
    bg = device('devices.generic.VirtualMotor',
                description = 'Backgard axis motor',
                abslimits = (-0.5, 31.0),
                unit = 'mm',
               ),
    monitor = device('devices.generic.VirtualMotor',
                     description = 'Monitor axis motor',
                     abslimits = (10, 300),
                     unit = 'mm',
                    ),
    top_theta = device('devices.generic.VirtualMotor',
                       description = 'Top Theta axis motor',
                       abslimits = (-9.5, 10.5),
                       unit = 'deg',
                      ),
    top_z = device('devices.generic.VirtualMotor',
