...
devices = dict(
    ...
    SampleSlitMotVB = device('devices.generic.VirtualMotor',
                             lowlevel = True,
                             abslimits = (-200, 46.425),
                             fmtstr = "%7.3f",
                             unit = 'mm',
                            ),
    SampleSlitMotVT = device('devices.generic.VirtualMotor',
                             lowlevel = True,
                             abslimits = (-200, 46.425),
                             fmtstr = "%7.3f",
                             unit = 'mm',
                            ),
    SampleSlitMotHL = device('devices.generic.VirtualMotor',
                             lowlevel = True,
                             abslimits = (-200, 27.5),
                             fmtstr = "%7.3f",
                             unit = 'mm',
                            ),
    SampleSlitMotHR = device('devices.generic.VirtualMotor',
                             lowlevel = True,
                             abslimits = (-200, 27.5),
                             fmtstr = "%7.3f",
                             unit = 'mm',
    ...
    ngc_motor = device('devices.generic.VirtualMotor',
