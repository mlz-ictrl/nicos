...
devices = dict(
    ...
    mon3   = device('devices.vendor.qmesydaq.QMesyDAQCounter',
                    description = 'QMesyDAQ Counter2',
                    tacodevice = qm + 'counter2',
                    type = 'monitor',
                   ),
    mon4   = device('devices.vendor.qmesydaq.QMesyDAQCounter',
                    description = 'QMesyDAQ Counter3',
                    tacodevice = qm + 'counter3',
                    type = 'monitor',
                   ),
    events = device('devices.vendor.qmesydaq.QMesyDAQCounter',
    ...
    det    = device('devices.vendor.qmesydaq.QMesyDAQMultiChannel',
