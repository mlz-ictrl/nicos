...
devices = dict(
    ...
    det1_timer = device('devices.generic.VirtualTimer',
                        description = 'demo timer',
                       ),
    det1_mon1 = device('devices.generic.VirtualCounter',
                       description = 'demo monitor',
                       type = 'monitor',
                      ),
    det1_mon2 = device('devices.generic.VirtualCounter',
                       description = 'demo monitor',
                       type = 'monitor',
                      ),
    det1_img  = device('devices.generic.VirtualImage',
