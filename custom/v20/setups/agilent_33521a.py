...
devices = dict(
    amp=device('devices.epics.EpicsWindowTimeoutDevice',
               ...
               timeout=None,
               unit='V'),
    freq=device('devices.epics.EpicsWindowTimeoutDevice',
                ...
                timeout=None,
                unit='Hz'),
    phase=device('devices.epics.EpicsWindowTimeoutDevice',
