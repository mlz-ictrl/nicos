...
devices = dict(
    tb_v1 = device('devices.tango.AnalogOutput',
    ...
    tb_v2 = device('devices.tango.AnalogOutput',
    ...
    tb_err_gaspressure = device('devices.tango.NamedDigitalOutput',
    ...
    tb_err_gastemp = device('devices.tango.NamedDigitalOutput',
    ...
    tb_err_motortemp = device('devices.tango.NamedDigitalOutput',
    ...
    tb_err_oil = device('devices.tango.NamedDigitalOutput',
    ...
    tb_err_power = device('devices.tango.NamedDigitalOutput',
    ...
    tb_err_waterin = device('devices.tango.NamedDigitalOutput',
    ...
    tb_err_waterout = device('devices.tango.NamedDigitalOutput',
    ...
    tb_state_run = device('devices.tango.NamedDigitalOutput',
    ...
    tb_warn_solenoid = device('devices.tango.NamedDigitalOutput',
    ...
    tb_compressor = device('devices.tango.NamedDigitalInput',
    ...
    tb_p1power = device('devices.tango.NamedDigitalInput',
    ...
    tb_gasvalve = device('devices.tango.NamedDigitalInput',
    ...
    tb_remote = device('devices.tango.NamedDigitalInput',
    ...
    tb_reset = device('devices.tango.NamedDigitalInput',
    ...
    tb_p2power = device('devices.tango.NamedDigitalInput',
    ...
    tb_vacuumvalve = device('devices.tango.NamedDigitalInput',
