...
devices = dict(
    shutter = device('nicos_mlz.pgaa.pilz.Switch',
    ...
    att1 = device('nicos_mlz.pgaa.pilz.Attenuator',
    ...
    att2 = device('nicos_mlz.pgaa.pilz.Attenuator',
    ...
    att3 = device('nicos_mlz.pgaa.pilz.Attenuator',
    ...
    att = device('nicos_mlz.pgaa.attenuator.Attenuator',
