...
devices = dict(
    ...
    omega_m = device('devices.taco.Motor',
    ...
    omega_e = device('devices.taco.Coder',
                     description = 'Z axis sample table encoder',
