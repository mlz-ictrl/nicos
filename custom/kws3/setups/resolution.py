...
devices = dict(
    ...
    sel_ap1_height  = device('nicos.devices.tango.Motor',
    ...
    sel_ap2_x_left  = device('nicos.devices.tango.Motor',
    ...
    sel_ap2_x_right = device('nicos.devices.tango.Motor',
    ...
    sel_ap2_y_upper = device('nicos.devices.tango.Motor',
    ...
    sel_ap2_y_lower = device('nicos.devices.tango.Motor',
