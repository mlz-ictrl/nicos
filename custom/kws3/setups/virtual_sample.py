...
devices = dict(
    ...
    sample_pos       = device('kws3.sample.SamplePos',
    ...
    sam_hub_x        = device('kws1.virtual.Standin',
                              description = 'sample 1st x-table',
                              lowlevel = True,
                             ),
    sam_hub_y        = device('kws1.virtual.Standin',
                              description = 'sample 1st y-table',
                              lowlevel = True,
                             ),
    sam10_x          = device('kws1.virtual.Standin',
                              description = 'sample 1st x-table in vacuum chamber',
                              lowlevel = True,
                             ),
    sam10_y          = device('kws1.virtual.Standin',
    ...
    sam01_x          = device('kws1.virtual.Standin',
                              description = 'sample 2nd x-table in vacuum chamber',
                              lowlevel = True,
                             ),
    sam01_y          = device('kws1.virtual.Standin',
