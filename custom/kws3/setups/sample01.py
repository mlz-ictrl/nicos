...
devices = dict(
    ...
    sam01_vac_x      = device("devices.tango.Motor",
                              description = "sample 2nd x-table in vacuum chamber",
                              tangodevice = tango_base + "fzjs7/sam2_x",
                              unit = "mm",
                              precision = 0.01,
                             ),
    sam01_vac_y      = device("devices.tango.Motor",
                              description = "sample 2nd y-table in vacuum chamber",
                              tangodevice = tango_base + "fzjs7/sam2_y",
                              unit = "mm",
                              precision = 0.01,
                             ),
    sam01_ap_x_left  = device("devices.tango.Motor",
                              description = "aperture sample 2nd jj-xray left",
                              tangodevice = tango_base + "fzjs7/sam2_ap_x_left",
                              unit = "mm",
                              precision = 0.01,
                              lowlevel = True,
                             ),
    sam01_ap_x_right = device("devices.tango.Motor",
                              ...
                              tangodevice = tango_base + "fzjs7/sam2_ap_x_right",
                              unit = "mm",
                              precision = 0.01,
                              lowlevel = True,
                             ),
    sam01_ap_y_upper = device("devices.tango.Motor",
                              ...
                              tangodevice = tango_base + "fzjs7/sam2_ap_y_upper",
                              unit = "mm",
                              precision = 0.01,
                              lowlevel = True,
                             ),
    sam01_ap_y_lower = device("devices.tango.Motor",
                              ...
                              tangodevice = tango_base + "fzjs7/sam2_ap_y_lower",
                              unit = "mm",
                              precision = 0.01,
                              lowlevel = True,
                             ),
