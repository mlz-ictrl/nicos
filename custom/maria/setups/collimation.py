...
devices = dict(
    giref = device("devices.tango.Motor",
    ...
    atten_A = device("devices.tango.NamedDigitalOutput",
                     description = "Attenuator A",
                     tangodevice = tango_dio + "/attenA",
                     mapping = atten_mapping,
                    ),
    atten_B = device("devices.tango.NamedDigitalOutput",
                     description = "Attenuator B",
                     tangodevice = tango_dio + "/attenB",
                     mapping = atten_mapping,
                    ),
    atten_C = device("devices.tango.NamedDigitalOutput",
