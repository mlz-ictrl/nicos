...
devices = dict(
    ...
    roi2          = device("devices.generic.RectROIChannel",
                           description = "ROI 2",
                           roi = (500, 350, 24, 344),
                          ),
    roi3          = device("devices.generic.RectROIChannel",
                           description = "ROI 3",
                           roi = (570, 300, 80, 424),
                          ),
    roi4          = device("devices.generic.RectROIChannel",
                           description = "ROI 4",
                           roi = (570, 200, 80, 624),
                          ),
    roi5          = device("devices.generic.RectROIChannel",
                           description = "ROI 5",
                           roi = (502, 497, 20, 30),
                          ),
    roi6          = device("devices.generic.RectROIChannel",
                           description = "ROI 6",
                           roi = (508, 300, 8, 420),
                          ),
