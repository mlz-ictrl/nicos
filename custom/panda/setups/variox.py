...
# DONT change names or the labview part wont work anymore !!!!!
    vti = device('devices.generic.CacheWriter',
    ...
    sTs = device('devices.generic.CacheReader',
                 description = 'Sample Temperature',
                 fmtstr = '%.3f',
                 unit = 'K',
                 maxage = 30,
                ),
    LN2 = device('devices.generic.CacheReader',
                 description = 'Level of Liquid Nitrogen',
                 fmtstr = '%.1f',
                 unit = '%',
                 maxage = 300,
                ),
    LHe = device('devices.generic.CacheReader',
                 description = 'Level of Liquid Helium',
                 fmtstr = '%.1f',
                 unit = '%',
                 maxage = 900,
                ),
    NV  = device('devices.generic.CacheWriter',
    ...
    vti_pressure = device('devices.generic.CacheWriter',
    ...
    #~ vti_pressure = device('devices.generic.CacheReader',
