...
devices = dict(
    ...
    sorb      = device('panda.cache.CacheWriter',
    ...
    onekpot   = device('panda.cache.CacheReader',
                    description = 'Temperature of precooling stage (1K-pot)',
                    fmtstr = '%.3f',
                    unit = 'K',
                    maxage=30,
                ),
    igh_p1   = device('panda.cache.CacheReader',
                    description = 'Pressure P1 of IGH',
                    fmtstr = '%.3f',
                    unit = 'mbar',
                    maxage=30,
                ),
    igh_p2   = device('panda.cache.CacheReader',
                    description = 'Pressure P2 of IGH',
                    fmtstr = '%.3f',
                    unit = 'mbar',
                    maxage=30,
                ),
    igh_g1   = device('panda.cache.CacheReader',
                    description = 'Pressure G1 of IGH',
                    fmtstr = '%.3f',
                    unit = 'mbar',
                    maxage=30,
                ),
    igh_g2   = device('panda.cache.CacheReader',
                    description = 'Pressure G2 of IGH',
                    fmtstr = '%.3f',
                    unit = 'mbar',
                    maxage=30,
                ),
    igh_g3   = device('panda.cache.CacheReader',
