...
devices = dict(
    ...
    occupied_sw       = device('devices.tango.DigitalInput',
                        tangodevice = tango_base + 'monochanger/plc_magazin_occ_sw',
                        description = 'Occupancy switches of the magazin',
                        ),
    magazine_status = device('devices.tango.NamedDigitalInput',
    ...
    magazinegrab  = device('devices.generic.Switcher',
                            description = 'Magazinclamp of Monochanger (MOVEABLE!!!)',
    ...
    tablegrab     = device('devices.generic.Switcher',
                            description = 'Tableclamp of Monochanger (MOVEABLE!!!)',
