...
devices = dict(
    wegbox_A_1ref = device('devices.taco.AnalogInput',
                           description = 'wegbox_A_1ref',
                           tacodevice = '%s/WB_A/1_6' % tacodev,
                          ),
    wegbox_A_2ref = device('devices.taco.AnalogInput',
                           description = 'wegbox_A_2ref',
                           tacodevice = '%s/WB_A/2_6' % tacodev,
                          ),
    wegbox_B_1ref = device('devices.taco.AnalogInput',
                           description = 'wegbox_B_1ref',
                           tacodevice = '%s/WB_B/1_6' % tacodev,
                          ),
    wegbox_B_2ref = device('devices.taco.AnalogInput',
                           description = 'wegbox_B_2ref',
                           tacodevice = '%s/WB_B/2_6' % tacodev,
                          ),
    wegbox_C_1ref = device('devices.taco.AnalogInput',
                           description = 'wegbox_C_1ref',
                           tacodevice = '%s/WB_C/1_6' % tacodev,
                          ),
    wegbox_C_2ref = device('devices.taco.AnalogInput',
