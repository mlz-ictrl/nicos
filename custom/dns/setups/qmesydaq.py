...
devices = dict(
    qmon1   = device('devices.vendor.qmesydaq.Counter',
                     description = 'QMesyDAQ Counter0',
                     tacodevice = qm + 'counter0',
                     type = 'monitor',
                    ),
    qmon2   = device('devices.vendor.qmesydaq.Counter',
                     description = 'QMesyDAQ Counter1',
                     tacodevice = qm + 'counter1',
                     type = 'monitor',
                    ),
    qevents = device('devices.vendor.qmesydaq.Counter',
                     description = 'QMesyDAQ Events channel',
                     tacodevice = qm + 'events',
                     type = 'counter',
                    ),
    qtimer  = device('devices.vendor.qmesydaq.Timer',
