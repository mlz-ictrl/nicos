...
devices = dict(
    ...
    atten1_i  = device('nicos_mlz.mira.beckhoff.DigitalInput',
                       tangodevice = tango_base + 'beckhoff/beckhoff2',
                       offset = 1,
                       lowlevel = True,
                      ),
    atten1_o  = device('nicos_mlz.mira.beckhoff.DigitalInput',
                       tangodevice = tango_base + 'beckhoff/beckhoff2',
                       offset = 0,
                       lowlevel = True,
                      ),
    atten1    = device('nicos_mlz.mira.switches.BeamElement',
    ...
    atten2_i  = device('nicos_mlz.mira.beckhoff.DigitalInput',
                       tangodevice = tango_base + 'beckhoff/beckhoff2',
                       offset = 3,
                       lowlevel = True,
                      ),
    atten2_o  = device('nicos_mlz.mira.beckhoff.DigitalInput',
                       tangodevice = tango_base + 'beckhoff/beckhoff2',
                       offset = 2,
                       lowlevel = True,
                      ),
    atten2    = device('nicos_mlz.mira.switches.BeamElement',
    ...
    Shutter   = device('nicos_mlz.mira.shutter.Shutter',
    ...
    PSDGas    = device('nicos_mlz.mira.beckhoff.NamedDigitalInput',
    ...
    Cooling   = device('nicos_mlz.mira.beckhoff.NamedDigitalInput',
