...
devices = dict(
    ...
    coilamp1 = device('nicos.taco.AnalogInput',
                      tacodevice = 'mira/tds2014/ch1_pk2pk',
                      pollinterval = 5,
                      maxage = 6),
    coilamp2 = device('nicos.taco.AnalogInput',
...
#                       variance = 5,
#                       fmtstr = '%.2f'),
    dc1       = device('nicos.mira.heinzinger.HeinzingerViaHPE',
                       tacodevice = 'mira/network/rs7_3',
                       abslimits = (0, 30),
                       fmtstr = '%.2f'),
#    dc2       = device('nicos.mira.ntn.Supply',
...
#                       fmtstr = '%.2f'),
   ...
   #                    fmtstr = '%.2f'),
    ...
    Cbox1     = device('nicos.mira.beckhoff.BeckhoffDigitalOutput',
                       tacodevice = 'mira/modbus/beckhoff',
                       startoffset = 0,
                       bitwidth = 32),
    Cbox2     = device('nicos.mira.beckhoff.BeckhoffDigitalOutput',
                       tacodevice = 'mira/modbus/beckhoff',
                       startoffset = 32,
                       bitwidth = 32),
