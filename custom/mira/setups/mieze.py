...
devices = dict(
    ...
    amp3     = device('nicos_mlz.mira.devices.rfcircuit.GeneratorDevice',
    ...
    freq3    = device('nicos_mlz.mira.devices.rfcircuit.GeneratorDevice',
    ...
    rf1      = device('nicos_mlz.mira.devices.rfcircuit.RFCurrent',
    ...
    rf2      = device('nicos_mlz.mira.devices.rfcircuit.RFCurrent',
