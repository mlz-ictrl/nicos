...
devices = dict(
    # gs1bus    = device('nicos.vendor.ipc.IPCModBusTCP',
    #                    host = 'mirars7.mira.frm2',
    #                    port = 4001,
    #                    lowlevel = True),

    # gs1_l_mot = device('nicos.vendor.ipc.SlitMotor',
    #                    lowlevel = True,
    #                    bus = 'gs1bus',
    #                    addr = 0x77,
    #                    side = 2,
    ...
    #                    resetpos = -30,
    #                    abslimits = (-32, 13)),
    # gs1_r_mot = device('nicos.vendor.ipc.SlitMotor',
    #                    lowlevel = True,
    #                    bus = 'gs1bus',
    #                    addr = 0x77,
    #                    side = 3,
    ...
    #                    resetpos = 30,
    #                    abslimits = (-13, 32)),
    # gs1_b_mot = device('nicos.vendor.ipc.SlitMotor',
    #                    lowlevel = True,
    #                    bus = 'gs1bus',
    #                    addr = 0x77,
    #                    side = 0,
    ...
    #                    resetpos = -45,
    #                    abslimits = (-60, 18)),
    # gs1_t_mot = device('nicos.vendor.ipc.SlitMotor',
    #                    lowlevel = True,
    #                    bus = 'gs1bus',
    #                    addr = 0x77,
    #                    side = 1,
    ...
    gs2bus    = device('nicos.vendor.ipc.IPCModBusTacoSerial',
                       tacodevice = 'mira/network/rsneu_1',
                       lowlevel = True),

    gs2_l_mot = device('nicos.vendor.ipc.SlitMotor',
                       lowlevel = True,
                       bus = 'gs2bus',
                       addr = 0x66,
                       side = 2,
                       ...
                       resetpos = -20,
                       abslimits = (-32, 13)),
    gs2_r_mot = device('nicos.vendor.ipc.SlitMotor',
                       lowlevel = True,
                       bus = 'gs2bus',
                       addr = 0x66,
                       side = 3,
                       ...
                       resetpos = 20,
                       abslimits = (-13, 32)),
    gs2_b_mot = device('nicos.vendor.ipc.SlitMotor',
                       lowlevel = True,
                       bus = 'gs2bus',
                       addr = 0x66,
                       side = 0,
                       ...
                       resetpos = -45,
                       abslimits = (-70, 17)),
    gs2_t_mot = device('nicos.vendor.ipc.SlitMotor',
                       lowlevel = True,
                       bus = 'gs2bus',
                       addr = 0x66,
                       side = 1,
