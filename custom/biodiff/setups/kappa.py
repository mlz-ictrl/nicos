...
devices = dict(
    ...
    omega_minikappa_m = device("biodiff.motor.MicrostepMotor",
                               description = "Mini-kappa omega axis "
                                             "(micro)",
