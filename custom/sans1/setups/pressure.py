...
devices = dict(
    tub_p1 = device('nicos.taco.AnalogInput',
                     tacodevice = nethost + 'sans1/tube/p1',
                     fmtstr = '',
                     pollinterval = 15,
                     maxage = 60,
                   ),
    tub_p2 = device('nicos.taco.AnalogInput',
                     tacodevice = nethost + 'sans1/tube/p2',
                     fmtstr = '',
                     pollinterval = 15,
                     maxage = 60,
                   ),
    tub_p3 = device('nicos.taco.AnalogInput',
                     tacodevice = nethost + 'sans1/tube/p3',
                     fmtstr = '',
                     pollinterval = 15,
                     maxage = 60,
                   ),
    coll_p1 = device('nicos.taco.AnalogInput',
                     tacodevice = nethost + 'sans1/coll/p1',
                     fmtstr = '',
                     pollinterval = 15,
                     maxage = 60,
                   ),
    coll_p2 = device('nicos.taco.AnalogInput',
                     tacodevice = nethost + 'sans1/coll/p2',
                     fmtstr = '',
                     pollinterval = 15,
                     maxage = 60,
                   ),
    coll_p3 = device('nicos.taco.AnalogInput',
