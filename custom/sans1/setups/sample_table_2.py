...
includes = ['system', 'sample_table_1']
...
devices = dict(
    st2_z    = device('devices.taco.axis.Axis',
                     description = 'sample table 2 z axis',
    ...
    st2_y    = device('devices.taco.axis.Axis',
                     description = 'sample table 2 y axis',
    ...
    st2_x    = device('devices.taco.axis.Axis',
                     description = 'sample table 2 x axis',
