...
devices = dict(
    ...
    det1_mon1 = device('devices.vendor.qmesydaq.Counter',
                       description = 'QMesyDAQ Counter0',
                       tacodevice = '//%s/sans1/qmesydaq/counter0' % nethost,
                       type = 'monitor',
                      ),
    det1_mon2 = device('devices.vendor.qmesydaq.Counter',
    ...
    #~ qm_ctr3= device('devices.vendor.qmesydaq.Counter',
                     ...
                     #~ type = 'monitor',
                     #~ ),
    det1_ev  = device('devices.vendor.qmesydaq.Counter',
                      description = 'QMesyDAQ Events channel',
                      tacodevice = '//%s/sans1/qmesydaq/events' % nethost,
                      type = 'counter',
                     ),
    det1_timer = device('devices.vendor.qmesydaq.Timer',
                        description = 'QMesyDAQ Timer',
                        tacodevice = '//%s/sans1/qmesydaq/timer' % nethost,
                       ),
    det1_image = device('devices.vendor.qmesydaq.Image',
