...
devices = dict(
    ...
    Histogram = device('nicos_mlz.frm2.qmesydaqsinks.HistogramSink',
    ...
    Listmode = device('nicos_mlz.frm2.qmesydaqsinks.ListmodeSink',
    ...
    DetectorSetup = device('nicos_mlz.sans1.copysink.CopySink',
    ...
    DetectorCalibration = device('nicos_mlz.sans1.copysink.CopySink',
