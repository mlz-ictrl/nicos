...
#                       ),
    ...
    det1_hv_interlock = device('nicos.devices.taco.DigitalInput',
                               description = 'interlock for detector 1 high voltage',
                               tacodevice = '//%s/sans1/interlock/hv' % (nethost, ),
                               lowlevel = True,
                              ),
    det1_hv_discharge_mode = device('nicos.devices.taco.DigitalInput',
                                    description = 'set discharge mode of detector 1',
                                    tacodevice = '//%s/sans1/interlock/mode' % (nethost, ),
                                    lowlevel = True,
                                   ),
    det1_hv_discharge = device('nicos.devices.taco.DigitalOutput',
    ...
    det1_hv_supply = device('nicos_mlz.sans1.hv.VoltageSupply',
    ...
    det1_hv_ax    = device('nicos_mlz.sans1.hv.Sans1HV',
    ...
    det1_hv_offtime = device('nicos_mlz.sans1.hv.Sans1HVOffDuration',
    ...
    det1_hv    = device('nicos_mlz.sans1.hv.VoltageSwitcher',
    ...
    det1_xmot = device('nicos.devices.taco.motor.Motor',
    ...
    det1_xenc = device('nicos.devices.taco.coder.Coder',
                       description = 'detector 1 x motor',
    ...
    det1_zmot = device('nicos_mlz.sans1.hv.Sans1ZMotor',
    ...
    det1_zenc = device('nicos.devices.taco.coder.Coder',
    ...
    det1_omegamot = device('nicos.devices.taco.motor.Motor',
    ...
    det1_omegaenc = device('nicos.devices.taco.coder.Coder',
    ...
    bs1_xmot = device('nicos.devices.taco.motor.Motor',
    ...
    bs1_ymot = device('nicos.devices.taco.motor.Motor',
