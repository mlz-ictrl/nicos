...
devices = dict(
    ...
    sc2    = device('devices.generic.MultiSwitcher',
                    ...
                    mapping = {11:  [592.5, -32], 10: [533.5, -32],
                                9:  [474.5, -32],  8: [415.5, -32],
                                7:  [356.5, -32],  6: [297.5, -32],
                                5:  [238.5, -32],  4: [179.5, -32],
                                3:  [120.5, -32],  2: [ 61.5, -32],
                                1: [  2.5, -32],
                               22: [592.5,  27], 21: [533.5,  27],
                               20: [474.5,  27], 19: [415.5,  27],
                               18: [356.5,  27], 17: [297.5,  27],
                               16: [238.5,  27], 15: [179.5,  27],
                               14: [120.5,  27], 13: [ 61.5,  27],
                               12: [  2.5,  27],
                               },
                    fallback = 0,
                    fmtstr = '%d',
