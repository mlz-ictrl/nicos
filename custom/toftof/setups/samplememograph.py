...
devices = {
    't_in_%s_cooling' % system[:2]: device('nicos_mlz.frm2.devices.memograph.MemographValue',
    ...
    't_out_%s_cooling' % system[:2]: device('nicos_mlz.frm2.devices.memograph.MemographValue',
                                            hostname = '%s' % memograph,
                                            group = _group,
    ...
    'p_in_%s_cooling' % system[:2]: device('nicos_mlz.frm2.devices.memograph.MemographValue',
                                           hostname = '%s' % memograph,
                                           group = _group,
    ...
    'p_out_%s_cooling' % system[:2]: device('nicos_mlz.frm2.devices.memograph.MemographValue',
                                            hostname = '%s' % memograph,
                                            group = _group,
    ...
    'flow_in_%s_cooling' % system[:2]: device('nicos_mlz.frm2.devices.memograph.MemographValue',
                                              hostname = '%s' % memograph,
                                              group = _group,
    ...
    'flow_out_%s_cooling' % system[:2]: device('nicos_mlz.frm2.devices.memograph.MemographValue',
                                               hostname = '%s' % memograph,
                                               group = _group,
    ...
    'leak_%s_cooling' % system[:2]: device('nicos_mlz.frm2.devices.memograph.MemographValue',
                                           hostname = '%s' % memograph,
                                           group = _group,
    ...
    'power_%s_cooling' % system[:2]: device('nicos_mlz.frm2.devices.memograph.MemographValue',
                                            hostname = '%s' % memograph,
                                            group = _group,
