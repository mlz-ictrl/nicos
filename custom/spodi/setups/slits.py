...
devices = dict(
# Monochromator slit
#   slitm_u = device('devices.vendor.caress.Motor',
...
#                    lowlevel = True,
#                   ),
#   slitm_d = device('devices.vendor.caress.Motor',
...
#                    lowlevel = True,
#                   ),
#   slitm_l = device('devices.vendor.caress.Motor',
...
#                    lowlevel = True,
#                   ),
#   slitm_r = device('devices.vendor.caress.Motor',
