...
devices = dict(
    ...
    p2_nguide = device('nicos.devices.taco.AnalogInput',
    ...
    p3_nguide = device('nicos.devices.taco.AnalogInput',
    ...
    o2_nguide = device('nicos.devices.taco.AnalogInput',
        description = 'O2',
    ...
    o2part_nguide = device('nicos.devices.taco.AnalogInput',
        description = 'O2 part',
    ...
    T_nguide = device('nicos.devices.taco.AnalogInput',
