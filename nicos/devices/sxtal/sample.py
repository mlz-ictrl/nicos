...
class SXTalSample(Sample):
    parameters = {
        ...
        'a':         Param('a', type=float, category='sample', unit='A'),
        'b':         Param('b', type=float, category='sample', unit='A'),
        'c':         Param('c', type=float, category='sample', unit='A'),
        'alpha':     Param('alpha', type=floatrange(1., 179.),
                           category='sample', unit='deg'),
