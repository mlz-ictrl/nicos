...
"""
Contains the subclass of NICOS specific for running in an interactive
Python shell.
"""
...
from nicos import nicos, nicos_version
from nicos.utils import colorcode
from nicos.errors import ModeError
from nicos.loggers import OUTPUT, INPUT
...
class InteractiveNICOS(NICOS):
    ...
    def console(self):
        ...
        banner = ('NICOS console ready (version %s).\nTry help() for a '
                  ...
                  % nicos_version)
        console = NicosInteractiveConsole(self, self._NICOS__namespace,
