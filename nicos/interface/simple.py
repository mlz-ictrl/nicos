...
"""
Contains the subclass of NICOS specific for running in noninteractive
...
from nicos.utils import writePidfile, removePidfile, daemonize
from nicos.errors import NicosError
from nicos.loggers import ColoredConsoleHandler
