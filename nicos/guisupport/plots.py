...
import gr
from gr import MARKERTYPE_DOT, MARKERTYPE_PLUS, \
    MARKERTYPE_ASTERISK, MARKERTYPE_CIRCLE, MARKERTYPE_DIAGONAL_CROSS, \
    MARKERTYPE_SOLID_CIRCLE, MARKERTYPE_TRIANGLE_UP, MARKERTYPE_SOLID_TRI_UP, \
    MARKERTYPE_TRIANGLE_DOWN, MARKERTYPE_SOLID_TRI_DOWN, MARKERTYPE_SQUARE, \
    MARKERTYPE_SOLID_SQUARE, MARKERTYPE_BOWTIE, MARKERTYPE_SOLID_BOWTIE, \
    MARKERTYPE_HOURGLASS, MARKERTYPE_SOLID_HGLASS, MARKERTYPE_DIAMOND, \
    MARKERTYPE_SOLID_DIAMOND, MARKERTYPE_STAR, MARKERTYPE_SOLID_STAR, \
    MARKERTYPE_TRI_UP_DOWN, MARKERTYPE_SOLID_TRI_RIGHT, \
    MARKERTYPE_SOLID_TRI_LEFT, MARKERTYPE_HOLLOW_PLUS, MARKERTYPE_SOLID_PLUS, \
    MARKERTYPE_PENTAGON, MARKERTYPE_HEXAGON, MARKERTYPE_HEPTAGON, \
    MARKERTYPE_OCTAGON, MARKERTYPE_STAR_4, MARKERTYPE_STAR_5, \
    MARKERTYPE_STAR_6, MARKERTYPE_STAR_7, MARKERTYPE_STAR_8, MARKERTYPE_VLINE, \
    MARKERTYPE_HLINE, MARKERTYPE_OMARK
import numpy.ma
