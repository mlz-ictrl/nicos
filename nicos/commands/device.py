...
def stop(*devlist):
    ...
    .. attention::
        ...
        commands or stop a running script.

        The next queued command or line in a script will be immediately
        executed and the stopped device(s) will be started again if the next
        commands in the queue require this.
